...
namespace Sigesoft.Node.Contasol.Integration
{
    public partial class frmConfirmarDespacho : Form
    {
        ...
        private string _diagnosticRepositoryId;
        public frmConfirmarDespacho(string serviceId, string diagnosticRepositoryId)
        {
            InitializeComponent();
            _serviceId = serviceId;
            _diagnosticRepositoryId = diagnosticRepositoryId;
        }
        ...
        private void Cargar()
        {
            ...
            try
            {
                ...
                {
                    _dataReporte = objRecetaBl.GetRecetaToReport(ref _objOperationResult, _serviceId, _diagnosticRepositoryId);
