    ...
    public class SecurityBL
    {
        ...
        public List<AutorizationList> GetAuthorizationExternal(ref OperationResult pobjOperationResult, int pintNodeId, int pintSystemUserId)
        {
            ...
            try
            {
                ...
                AutorizationList aa = new AutorizationList();
                aa.V_Description = "Auditar";
                aa.I_ParentId = 1;
                aa.I_ApplicationHierarchyId = 176;
                aa.V_Form = "~/frmMaster.aspx";
                aa.I_ApplicationHierarchyTypeId = 1;
                objAutorizationList.Add(aa);
              return objAutorizationList;
            }
            catch (Exception ex)
            {
