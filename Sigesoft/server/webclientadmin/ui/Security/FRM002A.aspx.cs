...
namespace Sigesoft.Server.WebClientAdmin.UI.Security
{
    public partial class FRM002A : System.Web.UI.Page
    {
        ...
        private void LoadComboBox()
        {
            ...
            ddlEspecialidad.DataTextField = "Description";
            ddlEspecialidad.DataValueField = "Id";
            ddlEspecialidad.DataSimulateTreeLevelField = "Level";
            ddlEspecialidad.DataEnableSelectField = "EnabledSelect";
            List<DataForTreeView> esp = _objDataHierarchyBL.GetDataHierarchyForCombo(ref objOperationResult1, 126);
            ddlEspecialidad.DataSource = esp;
            ddlEspecialidad.DataBind();
            this.ddlEspecialidad.Items.Insert(0, new FineUI.ListItem("-- Seleccione --", "-1"));
        ...
        protected void btnSaveRefresh_Click(object sender, EventArgs e)
        {
            ...
            if (Mode == "New")
            {
                ...
                objProfessional.i_Profesion = Convert.ToInt32(ddlEspecialidad.SelectedValue);
            ...
            else if (Mode == "Edit")
            {
                ...
                if (_objProfessional != null)
                {
                    ...
                    _objProfessional.i_Profesion = Convert.ToInt32(ddlEspecialidad.SelectedValue);
        ...
        private void LoadData()
        {
            ...
            else if (Mode == "Edit")
            {
                ...
                if (objProfessional != null)
                {
                    ...
                    ddlEspecialidad.SelectedValue = objProfessional.i_Profesion.ToString();
