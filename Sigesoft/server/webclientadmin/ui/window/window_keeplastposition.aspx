<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_keeplastposition.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.window.window_keeplastposition" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Button ID="btnShowWindow" Text="Show window (Keep the position and size of the last shutdown)" runat="server" EnablePostBack="false">
        </f:Button>
        <br />
        <br />
        ...
        <br />
        <br />
        Note: This example sets the window's KeepLastPosition="true" and KeepLastSize="true".
        <br />
        <f:Window ID="Window1" Width="650px" Height="300px" Icon="TagBlue" Title="Window" Hidden="true"
