<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_maximized.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.window.window_maximized" %>
...
<head runat="server">
    <title></title>
    <%--<style>
        /* Show collapse button when maximized */
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Window ID="Window1" Width="650px" Height="300px" IconFont="_Tag" Title="Window"
