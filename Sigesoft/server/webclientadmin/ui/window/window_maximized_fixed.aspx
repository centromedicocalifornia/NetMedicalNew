<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="window_maximized_fixed.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.window.window_maximized_fixed" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <f:Window ID="Window1" Width="650px" Height="300px" Icon="TagBlue" Title="Window (cannot restore window size)"
