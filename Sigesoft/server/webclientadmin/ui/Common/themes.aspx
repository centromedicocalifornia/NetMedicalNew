<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="themes.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Common.themes" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="themecontainer">
			<div class="grouptitle">
                Built-in (Pure color background)
            </div>
            <ul>
                <li>
                    <a href="javascript:;">
            ...
            <span class="note">Note: The background images of this group come from the network, the copyright belongs to the original author!
            </span>
            </div>
            <ul>
                <li>
