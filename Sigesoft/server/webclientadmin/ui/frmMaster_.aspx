...
<head id="Head1" runat="server">
    ...
    <title>CLINCIA SAN LORENZO S.R.L.</title>
     <style>
        .header .title {
...
<body>
    ...
    <x:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server"> 
        <Regions>
            <x:Region ID="Region1" Margins="5 5 5 5" Height="60px" ShowBorder="false" ShowHeader="false"
                    Position="Top" Layout="Fit" runat="server">
                    <Items>
                        <x:ContentPanel ShowBorder="false" CssClass="header" ShowHeader="false" BodyStyle="background-color:#29426a;"
                            ID="ContentPanel1" runat="server">
                            <table>
                                <tr>
                                    <%--<img id="Img1" src="E:\logo blanco.png" runat="server">--%>
                                    <td>
                                        <asp:Image id="Image1" runat="server" Height="59px" ImageUrl="~/images/LOGO-SAN-LORENZO-SL_2.png"  Width="40px" ImageAlign="TextTop" />

                                    </td>
                                    <td class="title" style="color: white; position: absolute; left: 60px; top: 10px;" >
                                        <%--<IMG SRC="E:\LOGO-SAN-LORENZO-SL_2.png" WIDTH=178 HEIGHT=180 BORDER=2>--%>
                                ...
                                <tr>
                                    <td style="color: white; position: absolute; right: 167px; top: 30px;">
            ...
            <x:Region ID="Region2" Split="true" Width="200px" Margins="0 0 0 0" ShowHeader="false"
                ...
                <Items>
                    <x:Accordion ID="Accordion1" Width="250px" Height="450px" runat="server" ShowBorder="false" ShowHeader="false"
                        ShowCollapseTool="true">
                        <Panes>
                            <x:AccordionPane ID="AccordionPane1" runat="server" Title="Menú" IconUrl="~/images/16/1.png" BodyPadding="2px 5px"
