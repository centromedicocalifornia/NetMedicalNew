...
namespace NetPdf
{
    public class AtencionIntegral
    {
            ...
            List<NoxiousHabitsList> listaHabitoNocivos)
        {
            ...
            page.Title = "HC:" + datosPac.v_DocNumber + " / F: " + datosPac.FechaServicio.ToString();
            document.Open();

            /////
            

            //iTextSharp.text.Image MarcaDeAgua = iTextSharp.text.Image.GetInstance("C:/Banner/PLANTILLA - VERTICAL.png");
            //MarcaDeAgua.ScalePercent(40);
            //MarcaDeAgua.SetAbsolutePosition(0, 0);
            //MarcaDeAgua.Alignment = iTextSharp.text.Image.UNDERLYING;
            //document.Add(MarcaDeAgua);
            ...
            { 
                ...
                new PdfPCell(new Phrase("ATENCIÓN MÉDICA - HISTORIA CLÍNICA", fontTitle1)) {HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 20f, Border = PdfPCell.NO_BORDER},
                //new PdfPCell(new Phrase("F.H.: " + datosPac.FechaServicio.ToString(), fontTitle1_2)) {HorizontalAlignment = iTextSharp.text.Element.ALIGN_RIGHT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 20f, Border = PdfPCell.NO_BORDER},
            ...
            cellsTit = new List<PdfPCell>()
                { 
                    ...
                    new PdfPCell(new Phrase("CONTACTO DE EMERGENCIA:", fontColumnValueBold)) { Colspan=6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=15f,UseVariableBorders=true, BorderColorLeft=BaseColor.BLACK,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.BLACK, BorderColorTop=BaseColor.BLACK},
                    new PdfPCell(new Phrase(datosPac.v_ContactName + " / Tel: " + datosPac.v_EmergencyPhone, fontColumnValue)) { Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda, UseVariableBorders=true, BorderColorLeft=BaseColor.WHITE,  BorderColorRight=BaseColor.BLACK,  BorderColorBottom=BaseColor.BLACK, BorderColorTop=BaseColor.BLACK },    
            ...
            ServiceComponentList historiaGinecologia = exams.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_ID);
            //if (historiaGinecologia != null)
            //{
            //    cellsTit = new List<PdfPCell>()
            //    { 
            //        new PdfPCell(new Phrase("ACOMPAÑANTE:", fontColumnValueBold)) { Colspan=4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=15f,UseVariableBorders=true, BorderColorLeft=BaseColor.BLACK,  BorderColorRight=BaseColor.WHITE,  BorderColorBottom=BaseColor.BLACK, BorderColorTop=BaseColor.BLACK},
            ...
            if (atenInte != null)
            {
                ...
                var signos_sintomas =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SIGNOS_SINTOMAS) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SIGNOS_SINTOMAS)
                            .v_Value1;
                //var enfer_actual =
                //    atenInte.ServiceComponentFields.Find(p =>
                //        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ENFERMEDAD_ACTUAL) == null
                //        ? ""
                //        : atenInte.ServiceComponentFields.Find(p =>
                //                p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ENFERMEDAD_ACTUAL)
                //            .v_Value1;
                var tiempoEnf =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_TIEMPO_EMF) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_TIEMPO_EMF).v_Value1;
                var apetito =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_APETITO) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_APETITO).v_Value1;
                var sed =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SED) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SED).v_Value1;
                var sueño =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SUEÑO) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SUEÑO).v_Value1;
                var estAnimo =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_EST_ANIMO) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_EST_ANIMO).v_Value1;
                var orina =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ORINA) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ORINA).v_Value1;
                var depos =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_DEPOSICIONES) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_DEPOSICIONES).v_Value1;

                cellsTit = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("MOTIVO DE CONSULTA", fontColumnValueBold1))
                    {
                    ...
                    new PdfPCell(new Phrase("SIGNOS Y SÍNTOMAS :", fontColumnValueBold))
                    {
                    ...
                    new PdfPCell(new Phrase(signos_sintomas, fontColumnValue))
                    {
                        Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    //new PdfPCell(new Phrase("ENFERMEDAD ACTUAL :", fontColumnValueBold))
                    //{
                    //    Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                    //    VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    //},
                    //new PdfPCell(new Phrase(enfer_actual, fontColumnValue))
                    //{
                    //    Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                    //    VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    //},
                    new PdfPCell(new Phrase("Tiempo de enfermedad :", fontColumnValueBold))
                    {
                        Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(tiempoEnf, fontColumnValue))
                    {
                        Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                ...
                columnWidths = new float[]
                    {3f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 3f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f};
                ...
                var relato_cronologico =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_RELATO_PATOLOGICO_DESC) ==
                    null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.ATENCION_INTEGRAL_RELATO_PATOLOGICO_DESC)
                            .v_Value1;

                cellsTit = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("RELATO CRONOLÓGICO", fontColumnValueBold1))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                        MinimumHeight = 15f
                    },
                    new PdfPCell(new Phrase(relato_cronologico == "" ? "-" : relato_cronologico, fontColumnValue))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                ...
                #region ANTECEDENTES OLD

                //var antecedentes =
                //    atenInte.ServiceComponentFields.Find(p =>
                //        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ANTECEDENTES) == null
                //        ? ""
                //        : atenInte.ServiceComponentFields.Find(p =>
                //            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ANTECEDENTES).v_Value1;
                ...
                //        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                //        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                //        MinimumHeight = tamaño_celda
                //    },

                //    new PdfPCell(new Phrase(antecedentes, fontColumnValue))
                //    {
                //        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                //        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 35f
                //    },
                //};
                ...
                if (listaHabitoNocivos != null)
                {
                    ...
                    Medicamentos = listaHabitoNocivos.FindAll(p => p.i_TypeHabitsId == (int)Sigesoft.Common.TypeHabit.Medicamentos);

                }
                string AntecedentesMedicinas = "";

                if (Medicamentos.Count != 0)
                {
                    foreach (var item in Medicamentos)
                    {
                        AntecedentesMedicinas += item.v_Frequency;
                    }
                }
                else
                {
                    AntecedentesMedicinas = "NO";
                }
                ...
                var dxMadre = listaPatologicosFamiliares.FindAll(p => p.v_TypeFamilyName == "MADRE");
                var dxHermanos = listaPatologicosFamiliares.FindAll(p => p.v_TypeFamilyName == "HERMANOS");
                var dxEspos = listaPatologicosFamiliares.FindAll(p => p.v_TypeFamilyName == "ESPOSO(A)");
                var dxHijos = listaPatologicosFamiliares.FindAll(p => p.v_TypeFamilyName == "HIJOS");
                string papa = "";
                if (dxPadre.Count != 0)
                {
                    foreach (var item in dxPadre)
                    {
                        papa += item.v_DiseaseName + " / " + item.v_Comment + ", ";
                    }
                }
                ...
                if (dxMadre.Count != 0)
                {
                    foreach (var item in dxMadre)
                    {
                        mama += item.v_DiseaseName + " / " + item.v_Comment + ", ";
                    }
                }

                string hermanos = "";
                if (dxHermanos.Count != 0)
                {
                    foreach (var item in dxHermanos)
                    {
                        hermanos += item.v_DiseaseName + " / " + item.v_Comment + ", ";
                    }
                }
                ...
                if (dxEspos.Count != 0)
                {
                    foreach (var item in dxEspos)
                    {
                        espos += item.v_DiseaseName + " / " + item.v_Comment + ", ";
                    }
                }
                ...
                if (dxHijos.Count != 0)
                {
                    foreach (var item in dxHijos)
                    {
                        hijos += item.v_DiseaseName + " / " + item.v_Comment + ", ";
                    }
                }
                if (papa != "")
                {
                    AntecedentesFamiliares += "PADRE : " + papa + " / ";
                }

                if (mama != "")
                {
                    AntecedentesFamiliares += "MADRE : " + mama + " / ";
                }

                if (hermanos != "")
                {
                    AntecedentesFamiliares += "HERMANOS : " + hermanos + " / ";
                }

                if (espos != "")
                {
                    AntecedentesFamiliares += "ESPOSO(A) : " + espos + " / ";
                }

                if (hijos != "")
                {
                    AntecedentesFamiliares += "HIJOS : " + hijos + " / ";
                }


                var Alergias = listMedicoPersonales.FindAll(p => p.v_DiseasesId == "N009-DD000000633" || p.v_DiseasesId == "N009-DD000002341"
                                                                || p.v_DiseasesId == "N009-DD000002031" || p.v_DiseasesId == "N009-DD000002016"
                                                                || p.v_DiseasesId == "N009-DD000002015" || p.v_DiseasesId == "N009-DD000001919"
                                                                || p.v_DiseasesId == "N009-DD000001774" || p.v_DiseasesId == "N009-DD000001730"
                                                                || p.v_DiseasesId == "N009-DD000001729" || p.v_DiseasesId == "N009-DD000001728"
                                                                || p.v_DiseasesId == "N009-DD000001717" || p.v_DiseasesId == "N009-DD000001542"
                                                                || p.v_DiseasesId == "N009-DD000001425" || p.v_DiseasesId == "N009-DD000001386"
                                                                || p.v_DiseasesId == "N009-DD000001333" || p.v_DiseasesId == "N009-DD000001311"
                                                                || p.v_DiseasesId == "N009-DD000001284" || p.v_DiseasesId == "N009-DD000001263"
                                                                || p.v_DiseasesId == "N009-DD000000886" || p.v_DiseasesId == "N009-DD000000880"
                                                                || p.v_DiseasesId == "N009-DD000000669" || p.v_DiseasesId == "N009-DD000000632");

                string AntecedentesAlergias = "";
                if (Alergias.Count != 0)
                {
                    foreach (var item in Alergias)
                    {
                        AntecedentesAlergias += item.v_DiseasesName + ": " + item.v_DiagnosticDetail + " / ";
                    }
                }
                else
                {
                    AntecedentesAlergias = "NINGUNA";
                }

                string AntecedentesCirugias = "";

                var Cirugias = listMedicoPersonales.FindAll(p => p.v_DiseasesId == Sigesoft.Common.Constants.CIRUGIAS || p.v_DiseasesId == "N009-DD000000637"
                                                                                                                      || p.v_DiseasesId == "N009-DD000002002" || p.v_DiseasesId == "N009-DD000002650"
                                                                                                                      || p.v_DiseasesId == "N009-DD000002001" || p.v_DiseasesId == "N009-DD000001645"
                                                                                                                      || p.v_DiseasesId == "N009-DD000000876" || p.v_DiseasesId == "N009-DD000002310");

                if (Cirugias.Count != 0)
                {
                    foreach (var item in Cirugias)
                    {
                        AntecedentesCirugias += item.v_DiagnosticDetail + " ( " + item.d_StartDate.Value.ToShortDateString() + " ) " + " - " + item.NombreHospital + ", C:" + item.v_Complicaciones;
                    }
                }
                else
                {
                    AntecedentesCirugias = "NINGUNA";
                }

                var Personales = listMedicoPersonales.FindAll(p => p.v_DiseasesId != "N009-DD000000633" && p.v_DiseasesId != "N009-DD000002341"
                                                                                                        && p.v_DiseasesId != "N009-DD000002031" && p.v_DiseasesId != "N009-DD000002016"
                                                                   && p.v_DiseasesId != "N009-DD000002015" && p.v_DiseasesId != "N009-DD000001919"
                                                                   && p.v_DiseasesId != "N009-DD000001774" && p.v_DiseasesId != "N009-DD000001730"
                                                                   && p.v_DiseasesId != "N009-DD000001729" && p.v_DiseasesId != "N009-DD000001728"
                                                                   ...
                                                                   && p.v_DiseasesId != "N009-DD000000886" && p.v_DiseasesId != "N009-DD000000880"
                                                                   && p.v_DiseasesId != "N009-DD000000669" && p.v_DiseasesId != "N009-DD000000632"
                                                                   && p.v_DiseasesId != Sigesoft.Common.Constants.CIRUGIAS && p.v_DiseasesId != "N009-DD000000637"
                                                                   && p.v_DiseasesId != "N009-DD000002002" && p.v_DiseasesId != "N009-DD000002650"
                                                                   && p.v_DiseasesId != "N009-DD000002001" && p.v_DiseasesId != "N009-DD000001645"
                                                                   && p.v_DiseasesId != "N009-DD000000876" && p.v_DiseasesId != "N009-DD000002310");
                ...
                if (Personales.Count != 0)
                {
                    ...
                    {
                        AntecedentesPersonales += item.v_DiseasesName + "(" + item.v_DiagnosticDetail + ") /" + item.d_StartDate.Value.ToShortDateString() + "/" + "-" + item.NombreHospital + ", ";
                    }
                }
                else
                {
                ...
                cellsTit = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("ANTECEDENTES PERSONALES :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesPersonales, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("MEDICACIÓN HABITUAL :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesMedicinas, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("ANTECEDENTES QUIRÚRGICOS :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesCirugias, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("ANTECEDENTES FAMILIARES :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f},
                    new PdfPCell(new Phrase(AntecedentesFamiliares, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f},
                    new PdfPCell(new Phrase("ALERGIAS :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesAlergias, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("O.A. :", fontColumnValueBold)){Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(otrosAntecedentes, fontColumnValue)){Colspan = 18, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                ...
                var estado_general =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.ATENCION_INTEGRAL_BUENE_ESTADO_GENERAL) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .ATENCION_INTEGRAL_BUENE_ESTADO_GENERAL).v_Value1;

                var amigdala_faringe =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.ATENCION_INTEGRAL_BOCA_AMIGDALA_FARINGE_LARINGE) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .ATENCION_INTEGRAL_BOCA_AMIGDALA_FARINGE_LARINGE).v_Value1;


                var piel_faneras =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.ATENCION_INTEGRAL_PIEL_FANERAS_TEJIDO_SUBCUTANEO) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants
                                .ATENCION_INTEGRAL_PIEL_FANERAS_TEJIDO_SUBCUTANEO).v_Value1;
                var aparato_respiratorio =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_RESPIRATORIO) ==
                    null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_RESPIRATORIO)
                            .v_Value1;
                var aparato_cardiovascular =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_CARDIOVASCULAR) ==
                    null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_CARDIOVASCULAR)
                            .v_Value1;
                var abdomen =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ABDOMEN) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_ABDOMEN).v_Value1;
                var aparato_genitourinario =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_GENITOURINARIO) ==
                    null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.ATENCION_INTEGRAL_APARATO_GENITOURINARIO)
                            .v_Value1;
                var sistema_nervioso =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SISTEMA_NERVIOSO) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_SISTEMA_NERVIOSO)
                            .v_Value1;
                var osteomuscular =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OSTEMUSCULAR) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OSTEMUSCULAR).v_Value1;

                var miemrbosInferiores =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_MIEMBROS_INFERIORES) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_MIEMBROS_INFERIORES).v_Value1;

                cellsTit = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("EXAMEN FISICO", fontColumnValueBold1))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                        MinimumHeight = 15F
                    ...
                    new PdfPCell(new Phrase("ESTADO GENERAL: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(estado_general, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("BOCA, AMIGDALA, FARINGE,LARINGE: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(amigdala_faringe, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    ...
                    new PdfPCell(new Phrase("PIEL, FANERAS Y TEJIDO CELULAR SUBCUTÁNEO: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(piel_faneras, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("APARATO RESPIRATORIO: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(aparato_respiratorio, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("APARATO CARDIOVASCULAR: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(aparato_cardiovascular, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("ABDOMEN: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    ...
                    new PdfPCell(new Phrase("APARATO GENITOURINARIO: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(aparato_genitourinario, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("SISTEMA NERVIOSO: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(sistema_nervioso, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("OSTEOMUSCULAR: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(osteomuscular, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },

                    new PdfPCell(new Phrase("MIEMBROS INFERIORES: ", fontColumnValueBold))
                    {
                        Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(miemrbosInferiores, fontColumnValue))
                    {
                        Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
            ...
            if (historiaGinecologia != null)
            {
                ...
                var signos_sintomas =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_SIGNOS_SINTOMAS) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_SIGNOS_SINTOMAS)
                            .v_Value1;
                var relato =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_RELATO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_RELATO)
                            .v_Value1;
                var trataimientoprevio =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_TRATAMIENTO_PREVIO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_TRATAMIENTO_PREVIO).v_Value1;
                
                var apetito =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_APETITO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_APETITO).v_Value1;
               var sueño =
                   historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_SUEÑO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_SUEÑO).v_Value1;
                var depos =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_DEPOSICIONES) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_DEPOSICIONES).v_Value1;
                var orina =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_ORINA) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_ORINA).v_Value1;
                
                cellsTit = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("ANAMNESIS", fontColumnValueBold1))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                        MinimumHeight = 15F
                    ...
                    new PdfPCell(new Phrase("SIGNOS Y SÍNTOMAS PRINCIPALES :", fontColumnValueBold))
                    {
                        Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f
                    },
                    new PdfPCell(new Phrase(signos_sintomas, fontColumnValue))
                    {
                        Colspan = 13, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f
                    },
                    new PdfPCell(new Phrase("RELATO :", fontColumnValueBold))
                    {
                        Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 35f
                    },
                    new PdfPCell(new Phrase(relato, fontColumnValue))
                    {
                        Colspan = 13, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 35f
                    },
                    new PdfPCell(new Phrase("TRATAMIENTO PREVIO :", fontColumnValueBold))
                    {
                        Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f
                    },
                    new PdfPCell(new Phrase(trataimientoprevio, fontColumnValue))
                    {
                        Colspan = 13, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 20f
                    },

                    new PdfPCell(new Phrase("FUNCIONES BIOLÓGICAS", fontColumnValueBold1))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                        MinimumHeight = 15F
                    ...
                    new PdfPCell(new Phrase("Apetito :", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f },
                    new PdfPCell(new Phrase(apetito, fontColumnValue)) {Colspan=5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f  },
                    new PdfPCell(new Phrase("Sueño :", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f },
                    new PdfPCell(new Phrase(sueño, fontColumnValue)) { Colspan=4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f  },
                    new PdfPCell(new Phrase("Deposiciones :", fontColumnValueBold)) { Colspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f },
                    new PdfPCell(new Phrase(depos, fontColumnValue)) { Colspan=4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f  },

                    new PdfPCell(new Phrase("Orina :", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f },
                    new PdfPCell(new Phrase(orina, fontColumnValue)) {Colspan=5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f  },
                    new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 13, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=17f},
                ...
                var hospitalizaciones =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_HOSPITALIZACIONES) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_HOSPITALIZACIONES).v_Value1;
                ...
                var otrosAntecedentes =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OTROS_ANTECEDENTES) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OTROS_ANTECEDENTES).v_Value1;
                ...
                cellsTit = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("MEDICACIÓN HABITUAL :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesMedicinas, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("HOSPITALIZACIONES :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(hospitalizaciones, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("ANTECEDENTES QUIRÚRGICOS :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase(AntecedentesCirugias, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},
                    new PdfPCell(new Phrase("ANTECEDENTES FAMILIARES :", fontColumnValueBold)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f},
                    new PdfPCell(new Phrase(AntecedentesFamiliares, fontColumnValue)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f},
                ...
                cellsTit = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("ANTECEDENTES GINECO OBSTÉTRICOS", fontColumnValueBold1))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor = BaseColor.GRAY,
                        MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(datosPac.d_Fur == null?"FUR: __/__/____":"FUR: " + datosPac.d_Fur.ToString().Split(' ')[0], fontColumnValue)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_CatemenialRegime == null ?"RC: _____/_____": "RC: "+ datosPac.v_CatemenialRegime, fontColumnValue)){Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_VolumenRC == null? "VOLUMEN: ___________":"VOLUMEN: "+datosPac.v_VolumenRC, fontColumnValue)){Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },

                    new PdfPCell(new Phrase(datosPac.i_MacId == null ?"MAC: NO ( )  SI ( ) ":datosPac.i_MacId == 1?"MAC: NO (X)  SI ( )":"MAC: NO ( )  SI (X)", fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_Mac == null ? "TIPO: _______________":"TIPO: " + datosPac.v_Mac , fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.d_MacInicio == null?"DESDE : __/__/____":"DESDE : " + datosPac.d_MacInicio.ToString().Split(' ')[0], fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.d_MacFin == null?"HASTA : __/__/____":"HASTA : " + datosPac.d_MacFin.ToString().Split(' ')[0], fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },

                    new PdfPCell(new Phrase(datosPac.v_Menarquia == null? "MENARQUIA: ________ ":"MENARQUIA: " + datosPac.v_Menarquia, fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_InicioVidaSexaul == null?"IRS: _______________" : "IRS: " + datosPac.v_InicioVidaSexaul, fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.i_RelacionesS == null?"RS: SI( ) NO ( )":datosPac.i_RelacionesS ==1?"RS: SI(X) NO ( )":datosPac.i_RelacionesS ==0?"RS: SI( ) NO (X)":"RS: SI( ) NO ( )", fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_NroParejasActuales == null?"N° PS: _______":"N° PS: " + datosPac.v_NroParejasActuales, fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.d_PAP == null ? "PAP: ____________" : "PAP: " + datosPac.d_PAP.ToString().Split(' ')[0], fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },

                    new PdfPCell(new Phrase(datosPac.i_Fertilidad == null ? "TRATAMIENTO FERTILIDAD: NO( ) SI( )" : datosPac.i_Fertilidad == 1?"TRATAMIENTO FERTILIDAD: NO( ) SI(X)" : datosPac.i_Fertilidad == 0?"TRATAMIENTO FERTILIDAD: NO(X) SI( )": "TRATAMIENTO FERTILIDAD: NO( ) SI( )", fontColumnValue)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2 },
                    new PdfPCell(new Phrase(datosPac.v_Fertilidad == null ? "               -     -     -                " : datosPac.v_Fertilidad, fontColumnValue2)){Colspan = 14, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda2},

                    new PdfPCell(new Phrase(datosPac.i_Dismenorrea == null ? "DISMENORREA: SI( ) NO( )" : datosPac.i_Dismenorrea == 1? "DISMENORREA: SI(X) NO( )": datosPac.i_Dismenorrea == 0? "DISMENORREA: SI( ) NO(X)" : "DISMENORREA: SI( ) NO( )", fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    new PdfPCell(new Phrase(datosPac.i_Dispareunia == null ? "DISPAREUNIA: SI( ) NO( )" : datosPac.i_Dispareunia == 1? "DISPAREUNIA: SI(X) NO( )": datosPac.i_Dispareunia == 0? "DISPAREUNIA: SI( ) NO(X)" : "DISPAREUNIA: SI( ) NO( )" , fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    new PdfPCell(new Phrase(datosPac.i_Coitorragia == null ? "COITORRAGIA: SI( ) NO( )" : datosPac.i_Coitorragia == 1? "COITORRAGIA: SI(X) NO( )": datosPac.i_Coitorragia == 0? "COITORRAGIA: SI( ) NO(X)" : "COITORRAGIA: SI( ) NO( )", fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    new PdfPCell(new Phrase(datosPac.i_Disquesia == null ? "DISQUESIA: SI( ) NO( )" : datosPac.i_Disquesia == 1? "DISQUESIA: SI(X) NO( )": datosPac.i_Disquesia == 0? "DISQUESIA: SI( ) NO(X)" : "DISQUESIA: SI( ) NO( )", fontColumnValue)){Colspan = 5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },

                    new PdfPCell(new Phrase(datosPac.v_Gestapara == null ? "G______P______" : datosPac.v_Gestapara, fontColumnValue)){Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    new PdfPCell(new Phrase(datosPac.v_FUP == null ? "FUP: __/__/_____" : "FUP: " + datosPac.v_FUP, fontColumnValue)){Colspan = 4, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    new PdfPCell(new Phrase(datosPac.i_TipoFUP == null ? "VAGINAL( ) CESÁREA( )" : datosPac.i_TipoFUP  == 1 ?"VAGINAL(X) CESÁREA( )" : datosPac.i_TipoFUP  == 2 ?"VAGINAL( ) CESÁREA(X)":"VAGINAL( ) CESÁREA( )", fontColumnValue)){Colspan = 10, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda },
                    
                    new PdfPCell(new Phrase("INTERCURRENCIAS EN GESTACIONES PREVIAS:", fontColumnValueBold))
                    {
                        Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                    new PdfPCell(new Phrase(datosPac.v_PrecisarCausas == null?"               -     -     -                " : datosPac.v_PrecisarCausas, fontColumnValue2))
                    {
                        Colspan = 13, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda
                    },
                ...
                //iTextSharp.text.Image imagenMinsa2 = iTextSharp.text.Image.GetInstance("C:/Banner/PLANTILLA - VERTICAL.png");
                ...
                var examenFisico =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_EXAMEN_FISICO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_EXAMEN_FISICO).v_Value1;
                ...
                cellsTit = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase(examenFisico, fontColumnValue))
                    {
                        Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,
                        VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 60f
                    },
            ...
            if (filterDiagnosticRepository != null && filterDiagnosticRepository.Count > 0)
            {
                ...
                foreach (var item in filterDiagnosticRepository)
                {
                    ...
                    {
                        cell = new PdfPCell(new Phrase(item.v_DiseasesName + " (" + item.v_Dx_CIE10 + ")", fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE };
                        cells.Add(cell);
                    }
            ...
            else if (historiaGinecologia != null)
            {
                planTera =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_PLAN_TERAPEUTICO) == null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_PLAN_TERAPEUTICO).v_Value1;

            }
             
            cellsTit = new List<PdfPCell>()
                { 
                    new PdfPCell(new Phrase("PLAN TERAPEUTICO", fontColumnValueBold1))
                    {
            ...
            if (medicina != null && medicina.Count > 0)
            {
                ...
                foreach (var item in medicina)
                {
                    ...
                    cell = new PdfPCell(new Phrase(item.FechaFin, fontColumnValue)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda };
                    cells2.Add(cell);
            ...
            {
                cells2.Add(new PdfPCell(new Phrase("- - -", fontColumnValue)) { Colspan = 6, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda });
                columnWidths = new float[] { 100f };
            }
            ...
            if (atenInte != null)
            {
                var fechaControl =
                    atenInte.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_PROX_CITA) == null
                        ? ""
                        : atenInte.ServiceComponentFields.Find(p =>
                            p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_PROX_CITA).v_Value1;
                if (fechaControl == servicio[0])
                {
                    //observaciones_new = atenInte.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OBSERVACIONES) == null ? "" : atenInte.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OBSERVACIONES).v_Value1;
                    observaciones_new = "";

                }
                else
                {
                    //observaciones_new = atenInte.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OBSERVACIONES) == null ? "" : atenInte.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_OBSERVACIONES).v_Value1 + " / FC: " + fechaControl;
            ...
            else if (historiaGinecologia != null)
            {
                var fechaControl =
                    historiaGinecologia.ServiceComponentFields.Find(p =>
                        p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_PROX_CITA) ==
                    null
                        ? ""
                        : historiaGinecologia.ServiceComponentFields.Find(p =>
                                p.v_ComponentFieldsId ==
                                Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_PROX_CITA)
                            .v_Value1;
                if (fechaControl == servicio[0])
                {
                    observaciones_new = historiaGinecologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OBSERVACIONES) == null ? "" : historiaGinecologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OBSERVACIONES).v_Value1;
                }
                else
                {
                    observaciones_new = historiaGinecologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OBSERVACIONES) == null ? "" : historiaGinecologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.ATENCION_INTEGRAL_GINECOLOGICA_OBSERVACIONES).v_Value1 + " / FC: " + fechaControl;
                }
            }
            ...
            cells = new List<PdfPCell>()
            {
                new PdfPCell(new Phrase("Obs: " + observaciones_new, fontColumnValueBold)){HorizontalAlignment = PdfPCell.ALIGN_LEFT,  VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE,  Colspan = 2, Rowspan = 2},
