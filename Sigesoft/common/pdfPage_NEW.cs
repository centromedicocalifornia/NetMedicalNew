...
namespace NetPdf
{
    public class pdfPage_NEW : PdfPageEventHelper
    {
        ...
        public override void OnStartPage(PdfWriter writer, Document doc)
        {
            ...
            if (Title != string.Empty)
            {
                ...
                cb.SetTextMatrix(pageSize.GetRight(170), pageSize.GetTop(50));
                cb.ShowText(Title);
                cb.EndText();
            }
            ...
            if (HeaderLeft + HeaderRight != string.Empty)
            {
                ...
                cb.SetRGBColorFill(0, 0, 0);
                HeaderTable.WriteSelectedRows(0, -1, pageSize.GetLeft(40), pageSize.GetTop(70), cb);
            }
        ...
        public override void OnEndPage(PdfWriter writer, Document doc)
        {
            ...
            var rutaImg = Sigesoft.Common.Utils.GetApplicationConfigValue("backgroundCSL");
