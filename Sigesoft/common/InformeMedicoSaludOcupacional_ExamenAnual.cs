        ...
        )
        {
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase(
                        "OTROS ANTECEDENTES: ENFERMEDADES Y ACCIDENTES",
                        fontColumnValueNegrita))
                    {Colspan = 3, HorizontalAlignment = PdfPCell.ALIGN_LEFT},

                //fila
                new PdfPCell(new Phrase("ENFERMEDAD", fontColumnValue))
                    {Rowspan = 1, HorizontalAlignment = PdfPCell.ALIGN_CENTER},
            ...
            foreach (var item in listMedicoPersonales)
            {
               ...
               cell = new PdfPCell(new Phrase(
                        ...
                        fontColumnValue)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE };
                cells.Add(cell);
            ...
            columnWidths = new float[] { 50f, 10f, 40f };
