            ...
            string filePDF, UsuarioGrabo DatosGrabo)
        {
           ...
           if (empresageneral != empresasubcontrata) empr_Conct = empresacontrata + " / " + empresasubcontrata;
            ...
            {         
                ...
                new PdfPCell(new Phrase(observacion_conducta, fontColumnValue)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 12f},    
            };
            ...
            {         
                ...
                new PdfPCell(new Phrase(evaluaciones_comp == null ?"NO PRESENTA EVALUACIONES COMPLEMENTARIAS":evaluaciones_comp, fontColumnValue)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 12f},    
            };

                columnWidths = new float[] { 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f, 5f };
                table = HandlingItextSharp.GenerateTableFromCells(cells, columnWidths, null, fontTitleTable);
                document.Add(table);
                #endregion XI. FACTORES PSICOSOCIALES
            ...
            {         
                ...
                new PdfPCell(new Phrase(riesgospsicosociales, fontColumnValue)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 12f},    
            };
            ...
            {         
                ...
                new PdfPCell(new Phrase(psicosensometrico, fontColumnValue)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 12f},    
            };
            ...
            {         
                ...
                new PdfPCell(new Phrase("OBSERVACIONES: " + conclusion_desc == null ?"NO PRESENTA OBSERVACIONES - APTO":conclusion_desc, fontColumnValueBold)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 15f},    
            };
           ...
           #region  RECOMENDACIONES
            ...
            {         
                ...
                new PdfPCell(new Phrase("RECOMENDACIÓN: " + recomendacion == null ?"NO REFIERE RECOMENDACIONE":recomendacion, fontColumnValueBold)) { Colspan =20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 12f},    
            ...
            if (DatosGrabo.Firma != null)
                cellFirma = new PdfPCell(HandlingItextSharp.GetImage(DatosGrabo.Firma, null, null, 120, 40)) { HorizontalAlignment = PdfPCell.ALIGN_CENTER };
            else
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase("FIRMA DEL EXAMINADO", fontColumnValueBold)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 10f},    
                new PdfPCell(new Phrase("Huella DEL EXAMINADO", fontColumnValueBold)) { HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 10f},    
