...
namespace NetPdf
{
    public class Coprocultivo_PSeriado_Lumina
    {
        ...
        public static void CreateExamen_PARASITOLOGICO_COPROCULTIVO_LUMINA(PacientList filiationData,
           ...
           string filePDF, UsuarioGrabo DatosGrabo, List<DiagnosticRepositoryList> Diagnosticos)
        {
            ...
            Font fontColumnValueBold3 = FontFactory.GetFont("Calibri", 10, iTextSharp.text.Font.BOLD|Font.UNDERLINE, new BaseColor(System.Drawing.Color.Black));
            ...
            ServiceComponentList cabecera = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.ADICIONALES_LUMINA);
            var identificacion = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_IDENTIFICACION_LUMINA) == null ? "FALTA LLENAR" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_IDENTIFICACION_LUMINA).v_Value1;
            var fechaemision = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_FECHA_EMISION_LUMINA) == null ? "FALTA LLENAR" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_FECHA_EMISION_LUMINA).v_Value1;
            var medico = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_MEDICO_LUMINA) == null ? "FALTA LLENAR" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CABECERA_DATOS_MEDICO_LUMINA).v_Value1;
            ...
            ServiceComponentList microbiologia = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.MICROBIOLOGIA_ID_LUMINA);
            ServiceComponentList microbiologia2 = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.MICROBIOLOGIA_ID_LUMINA_2);

            #region DATOS PARASITOLOGICO SERIADO -MICROBIOLOGIA
            if (microbiologia != null && microbiologia2 != null)
            {
                var color = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_COLOR_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_COLOR_LUMINA).v_Value1Name;
                var consistencia = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_CONSISTENCIA_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_CONSISTENCIA_LUMINA).v_Value1Name;
                var moco = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_MOCO_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_MOCO_LUMINA).v_Value1Name;
                var thevenon = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_THEVENON_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_THEVENON_LUMINA).v_Value1Name;
                var restos_alimenticios = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_RESTOS_ALIMENTICIOS_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_RESTOS_ALIMENTICIOS_LUMINA).v_Value1Name;
                var leucocitos = microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_LEUCOCITOS_LUMINA) == null ? "FALTA LLENAR" : microbiologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_LEUCOCITOS_LUMINA).v_Value1;

                var hematies = microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_HEMATIES_LUMINA) == null ? "FALTA LLENAR" : microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_HEMATIES_LUMINA).v_Value1;
                var levaduras = microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_LEVADURAS_LUMINA) == null ? "FALTA LLENAR" : microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_LEVADURAS_LUMINA).v_Value1;
                var parasitos = microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_PARASITOS_LUMINA) == null ? "FALTA LLENAR" : microbiologia2.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MICROBIOLOGIA_C_A_PARASITOS_LUMINA).v_Value1;

                cells = new List<PdfPCell>()
                    {
                        new PdfPCell(new Phrase("\n", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("\nEXAMEN MACROSCOPICO", fontColumnValueBold3)) { Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("\n", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        ...
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("PARASITOS", fontColumnValueBold)) { Colspan = 7, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase(": " + parasitos, fontColumnValue)) { Colspan = 8, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            ...
            //NO PASAR POR SER EXAMEN DIRECTO
            //ServiceComponentList reaccion_inflamatoria = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.HECES_DIRECTO_LUMINA_ID);

            //if (reaccion_inflamatoria != null)
            //{

            //    var metodo_Directo_1 = reaccion_inflamatoria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.HECES_DIRECTO_METODO_DIRECTO_C_A_LUMINA) == null ? "FALTA LLENAR" : reaccion_inflamatoria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.HECES_DIRECTO_METODO_DIRECTO_C_A_LUMINA).v_Value1;
            //    var metodo_Sedimentacion_1 = reaccion_inflamatoria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.HECES_DIRECTO_METODO_SEDIMENTACION_C_A_LUMINA) == null ? "FALTA LLENAR" : reaccion_inflamatoria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.HECES_DIRECTO_METODO_SEDIMENTACION_C_A_LUMINA).v_Value1;


            //    cells = new List<PdfPCell>()
            //            {
            //                new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            //                new PdfPCell(new Phrase("EXAMEN DIRECTO DE HECES", fontColumnValueBold)) { Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.BLACK, BorderColorTop = BaseColor.BLACK },    
            //                new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            //             };
            ...
            //            new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            //            new PdfPCell(new Phrase(metodo_Sedimentacion_1, fontColumnValue)) { Colspan = 15, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 20f,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            //            new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            ...
            ServiceComponentList parasitologico = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.PARASITOLOGICO_SERIADO_LUMINA_ID);


            if (parasitologico != null)
            {
                var metodo_Directo = parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.METODO_DIRECTO_C_A_LUMINA) == null ? "FALTA LLENAR" : parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.METODO_DIRECTO_C_A_LUMINA).v_Value1;
                var metodo_Sedimentacion = parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.METODO_SEDIMENTACION_C_A_LUMINA) == null ? "FALTA LLENAR" : parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.METODO_SEDIMENTACION_C_A_LUMINA).v_Value1;

                var cantidad = parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CANTIDAD_DE_EXAMENES_LUMINA) == null ? "FALTA LLENAR" : parasitologico.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CANTIDAD_DE_EXAMENES_LUMINA).v_Value1;
            ...
            ServiceComponentList coprocultivo = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.COPROCULTIVO_ID_LUMINA);

            if (coprocultivo != null)
            {
                var coprocultivo_esp = coprocultivo.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.COPROCULTIVO_LUMINA) == null ? "FALTA LLENAR" : coprocultivo.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.COPROCULTIVO_LUMINA).v_Value1;
        ...
        public static void CreateExamen_AGLUTINACIONES_KOH_SECRECION_LUMINA(PacientList filiationData,
           List<ServiceComponentList> serviceComponent,
           organizationDto infoEmpresa,
           PacientList datosPac,
           string filePDF, UsuarioGrabo DatosGrabo, List<DiagnosticRepositoryList> Diagnosticos)
        {
            ...
            ServiceComponentList inmunologia = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.INMUNOLOGIA_ID_CA_LUMINA);
            if (inmunologia != null)
            {
                var a = inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_A_CA_LUMINA) == null ? "FALTA LLENAR" : inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_A_CA_LUMINA).v_Value1;
                var b = inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_B_CA_LUMINA) == null ? "FALTA LLENAR" : inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_B_CA_LUMINA).v_Value1;
                var o = inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_O_CA_LUMINA) == null ? "FALTA LLENAR" : inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_O_CA_LUMINA).v_Value1;
                var h = inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_H_CA_LUMINA) == null ? "FALTA LLENAR" : inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.INMUNOLOGIA_H_CA_LUMINA).v_Value1;
                var brucella = inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.BRUCELLS_SBORTUS_CA_LUMINA) == null ? "FALTA LLENAR" : inmunologia.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.BRUCELLS_SBORTUS_CA_LUMINA).v_Value1;
            ...
            ServiceComponentList rapado_uñas = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.RASPADO_UÑAS_ID_LUMINA);
            if (rapado_uñas != null)
            {
                var koh = rapado_uñas.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RASPADO_UÑAS_LUMINA) == null ? "FALTA LLENAR" : rapado_uñas.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RASPADO_UÑAS_LUMINA).v_Value1;
                ...
                cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("KOH UNGEAL DEDOS DE MANO", fontColumnValueBold2)) { Colspan = 18, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.BLACK, BorderColorTop = BaseColor.BLACK },    
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
            ...
            ServiceComponentList secresion_faringea = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.SECRECION_FARINGEA_ID_LUMINA);
            if (secresion_faringea != null)
            {
                var muestra = secresion_faringea.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MUESTRA_SECRECION_FARINGEA_LUMINA) == null ? "FALTA LLENAR" : secresion_faringea.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.MUESTRA_SECRECION_FARINGEA_LUMINA).v_Value1;
                var germen_aislado = secresion_faringea.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.GERMEN_AISLADO_SECRECION_FARINGEA_LUMINA) == null ? "FALTA LLENAR" : secresion_faringea.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.GERMEN_AISLADO_SECRECION_FARINGEA_LUMINA).v_Value1;
                ...
                cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
                        new PdfPCell(new Phrase("CULTIVO NASOFARINGEO", fontColumnValueBold2)) { Colspan = 18, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.BLACK, BorderColorBottom = BaseColor.BLACK, BorderColorTop = BaseColor.BLACK },    
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda,  UseVariableBorders = true, BorderColorLeft = BaseColor.BLACK, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE },    
