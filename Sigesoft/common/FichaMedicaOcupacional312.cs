    ...
    public class FichaMedicaOcupacional312
    {
            ...
            string filePDF)
        {
            ...
            string OTROS_HALLAZGOS =
                ExamenFisco.Count() == 0 || (ExamenFisco.Find(p =>
                    p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXAMEN_FISICO_HALLAZGOS_ID)
                ) == null
                    ? string.Empty
                    : (ExamenFisco.Find(p =>
                        p.v_ComponentFieldsId ==
                        Sigesoft.Common.Constants.EXAMEN_FISICO_HALLAZGOS_ID)).v_Value1;
            ...
            cells = new List<PdfPCell>()
            {
                ...
                new PdfPCell(new Phrase(SistemaNervioso, fontColumnValue))
                    ...
                    //fila                                                
                new PdfPCell(new Phrase("OTROS HALLAZGOS", fontColumnValue)),
                new PdfPCell(new Phrase(OTROS_HALLAZGOS, fontColumnValue))
                    {Colspan = 11, HorizontalAlignment = PdfPCell.ALIGN_LEFT}
