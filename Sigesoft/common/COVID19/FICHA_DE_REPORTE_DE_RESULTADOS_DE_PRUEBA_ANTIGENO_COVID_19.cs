...
namespace NetPdf
{
    public class FICHA_DE_REPORTE_DE_RESULTADOS_DE_PRUEBA_ANTIGENO_COVID_19
    {
        ...
        public static void CreateFICHA_DE_REPORTE_DE_RESULTADOS_DE_PRUEBA_ANTIGENO_COVID_19(PacientList filiationData,
         ...
         NombreMedicoLab _nombreMedico, NombreEmpresaLab _nombreEmpresa, UsuarioGrabo MedicoOcupacional)
        {
            ...
            Font fontColumnValueApendice = FontFactory.GetFont("Calibri", 5, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.Black));
                ...
                string medico = "";
                ServiceComponentList cabecera = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_ID);
                var identificacion = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_IDENTIFICACION) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_IDENTIFICACION).v_Value1;
                var fechaemision = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_FECHA_EMISION) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_FECHA_EMISION).v_Value1;
                var hora = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_HORA) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_HORA).v_Value1;
                ...
                if (_nombreMedico != null)
                {
                    ...
                    {
                        medico = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_MEDICO) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.RESULTADO_PRUEBA_DE_ANTIGENO_COVID_19_MEDICO).v_Value1;
                    }
                }
                else
                {
                ...
                cells = new List<PdfPCell>()
            {
                ...
                cells = new List<PdfPCell>()
                    {
                        ...
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 8f, Border = PdfPCell.NO_BORDER },    
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 18, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 8f, Border = PdfPCell.NO_BORDER },    
                        new PdfPCell(new Phrase("", fontColumnValueBold)) { Colspan = 1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 8f, Border = PdfPCell.NO_BORDER },    
                ...
                cells = new List<PdfPCell>()
                {
                    new PdfPCell(new Phrase("", fontColumnValueBold)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_RIGHT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 8f, Border = PdfPCell.NO_BORDER},    
                    
                    new PdfPCell(cellMedico){MinimumHeight = 60f, HorizontalAlignment = PdfPCell.ALIGN_CENTER, Border = PdfPCell.NO_BORDER},

                    new PdfPCell(cellFirma){MinimumHeight = 60f, HorizontalAlignment = PdfPCell.ALIGN_RIGHT, Border = PdfPCell.NO_BORDER},
