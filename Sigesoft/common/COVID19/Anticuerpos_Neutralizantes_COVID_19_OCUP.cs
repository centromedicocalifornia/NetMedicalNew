...
namespace NetPdf
{
    public class Anticuerpos_Neutralizantes_COVID_19_OCUP
    {
        ...
        public static void CreateAnticuerpos_Neutralizantes_COVID_19_OCUP(PacientList filiationData,
        List<ServiceComponentList> serviceComponent,
        organizationDto infoEmpresa,
        PacientList datosPac,
        string filePDF, UsuarioGrabo DatosGrabo,
         NombreMedicoLab _nombreMedico, NombreEmpresaLab _nombreEmpresa, UsuarioGrabo MedicoOcupacional)
        {
            ...
            string medico = "";
            ServiceComponentList cabecera = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_ID);
            var identificacion = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_IDENTIFICACION) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_IDENTIFICACION).v_Value1;
            var fechaemision = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_FECHA_EMISION) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_FECHA_EMISION).v_Value1;
            var hora = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_HORA) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_HORA).v_Value1;
            ...
            if (_nombreMedico != null)
            {
                ...
                {
                    medico = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_MEDICO) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_MEDICO).v_Value1;
                }
            }
            else
            {
            ...
            var resultado = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_RESULTADO) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_RESULTADO).v_Value1;
            var unidad = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_RESULTADO) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_RESULTADO).v_MeasurementUnitName;
            var valordeseado = cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_DESEADO) == null ? "- - -" : cabecera.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.Anticuerpos_Neutralizantes_COVID_19_DESEADO).v_Value1;
            ...
            //if (filiationData.empresa_ == "STRACON S.A." || filiationData.contrata == "STRACON S.A." || filiationData.subcontrata == "STRACON S.A.")
            if (filiationData.empresa_ == "SOUTHERN PERU COPPER CORPORATION SUCURSAL DEL PERU" || filiationData.contrata == "SOUTHERN PERU COPPER CORPORATION SUCURSAL DEL PERU" || filiationData.subcontrata == "SOUTHERN PERU COPPER CORPORATION SUCURSAL DEL PERU")
            {
                if (MedicoOcupacional.Firma != null)
                    cellMedico = new PdfPCell(HandlingItextSharp.GetImage(MedicoOcupacional.Firma, null, null, 160, 80));
                else
            ...
            cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(cellMedico){MinimumHeight = 60f, HorizontalAlignment = PdfPCell.ALIGN_CENTER,  UseVariableBorders = true, BorderColorLeft = BaseColor.WHITE, BorderColorRight = BaseColor.WHITE, BorderColorBottom = BaseColor.WHITE, BorderColorTop = BaseColor.WHITE},
