...
namespace NetPdf
{
    public class ConsentimientoInformadoExamenCovid19
    {
        ...
        public static void CreateConsentimientoInformadoExamenCovid19(ServiceList DataService, string filePDF,
         ...
         List<ServiceComponentList> serviceComponent)
        {
            ...
            ServiceComponentList covid = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_COVID_19_ID_OC);

            #region INFORMACIÓN GENERAL
            string empresa = "";
            if (covid != null)
            {
                empresa = covid.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_COVID_19_EMPRESA) == null ? "- - -" : covid.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_COVID_19_EMPRESA).v_Value1;
            }
