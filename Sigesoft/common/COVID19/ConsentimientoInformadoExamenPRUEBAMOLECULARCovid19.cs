...
namespace NetPdf
{
    public class ConsentimientoInformadoExamenPRUEBAMOLECULARCovid19
    {
        ...
        public static void CreateConsentimientoInformadoExamenMOLECULARCovid19(ServiceList DataService, string filePDF,
         ...
         List<ServiceComponentList> serviceComponent)
        {
            ...
            var cellsTit = new List<PdfPCell>()
                { 
                    ...
                    new PdfPCell(new Phrase("\nConsentimiento Informado para examen de COVID-19", fontTitle1)) {Colspan = 2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f, Border = PdfPCell.NO_BORDER},
                    new PdfPCell(new Phrase("\n", fontColumnValueBold1)) {HorizontalAlignment = iTextSharp.text.Element.ALIGN_RIGHT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 40f, Border = PdfPCell.NO_BORDER},
            ...
            ServiceComponentList covid = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_PRUEBA_MOLECULAR_COVID_19_ID_OC);

            #region INFORMACIÓN GENERAL
            string empresa = "";
            if (covid != null)
            {
                empresa = covid.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_PRUEBA_MOLECULAR_COVID_19_EMPRESA) == null ? "- - -" : covid.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.CONSENTIMIENTO_INFORMADO_PARA_EXAMENES_DE_PRUEBA_MOLECULAR_COVID_19_EMPRESA).v_Value1;
            }
            ...
            {    
                ...
                new PdfPCell(new Phrase("", fontColumnValueBold)){ Colspan = 1 , HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, Border = PdfPCell.NO_BORDER},    
                new PdfPCell(new Phrase("COVID-19, con la toma de muestra hisopada, teniendo encuenta que:", fontColumnValue)){ Colspan = 18 , HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, Border = PdfPCell.NO_BORDER},    
                new PdfPCell(new Phrase("", fontColumnValueBold)){ Colspan = 1 , HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda, Border = PdfPCell.NO_BORDER},    
