...
namespace NetPdf
{
    public class ConsentimientoInformadoExamenPRUEBAANTIGENOCovid19
    {
        ...
        public static void CreateConsentimientoInformadoExamenPRUEBAANTIGENOCovid19(ServiceList DataService, string filePDF,
