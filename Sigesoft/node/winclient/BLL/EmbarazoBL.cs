...
namespace Sigesoft.Node.WinClient.BLL
{
    public class EmbarazoBL
    {
        ...
        public List<Embarazo> GetEmbarazoFiltered(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrPersonId)
        {
            try
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = from A in dbContext.getembarazofiltered_sp(pstrPersonId)
                            select new Embarazo
                            {
