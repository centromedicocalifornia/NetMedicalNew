   ...
   public class OperationsNatclarBl
    {
        ...
        {
            DateTime Desde = fi.Value.Date;
            DateTime Hasta = ff.Value.Date.AddDays(1);
            ...
            var query = (from a in dbContext.service
                        join b in dbContext.person on a.v_PersonId equals b.v_PersonId
                         ...
                         where a.d_ServiceDate.Value >= Desde && a.d_ServiceDate.Value <= Hasta
            ...
            List<OperationsNatclarBe> data = query.OrderBy(o => o.v_ServiceId).ToList();



           // data = data.GroupBy(p => p.v_ServiceId).Select(s => s.First()).ToList();
            return data;
        }
