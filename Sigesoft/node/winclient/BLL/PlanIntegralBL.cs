...
namespace Sigesoft.Node.WinClient.BLL
{
    ...
    {
        public List<PlanIntegralList> GetPlanIntegralAndFiltered(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrPersonId)
        {
            try
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = from A in dbContext.getplanintegralandfiltered_sp(pstrPersonId)
