...
namespace Sigesoft.Node.WinClient.BLL
{
    public class SecurityBL
    {
        ...
        public List<KeyValueDTO> GetFormAction_OLD(ref OperationResult pobjOperationResult, int pintNodeId, int pintRoleId, int pintSystemUserId, string pstrFormCode)
        {
            try
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
        ...
        public List<KeyValueDTO> GetFormAction(ref OperationResult pobjOperationResult, int pintNodeId, int pintRoleId, int pintSystemUserId, string pstrFormCode)
        {
            try
            {
                ...
                var query = (from a in dbContext.getformaction_sp(pintNodeId, pintRoleId, pintSystemUserId, pstrFormCode)
                                      select new KeyValueDTO
                                      {
                                          Value1 = a.Value1,
                                          Value2 = a.Value2
        ...
        public int AddSystemUSer(ref OperationResult pobjOperationResult, systemuserDto pobjDtoEntity, List<string> ClientSession)
        {
            ...
            try
            {
                ...
                SecuentialId = Utils.UsuarioNuevoId();
                SecuentialId = SecuentialId + 1;
