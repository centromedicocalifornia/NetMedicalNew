...
namespace Sigesoft.Node.WinClient.BLL
{
    public class SystemParameterBL
    {
        ...
        public List<SystemParameterList> GetSystemParametersPagedAndFiltered_OLD(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, int? pintGroupId)
        {
            //mon.IsActive = true;
        ...
        public List<SystemParameterList> GetSystemParametersPagedAndFiltered(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, int? pintGroupId)
        {
            ...
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = (from A in dbContext.getsystemparameterspagedandfilterednew2_sp(pintGroupId)
                            select new SystemParameterList
                            {
                                i_GroupId = A.i_GroupId,
                                i_ParameterId = A.i_ParameterId,
                                i_ParentGroupId = A.i_ParentGroupId,
                                i_ParentParameterId = A.i_ParentParameterId.ToString() == "NULL" ? -1 : A.i_ParentParameterId.Value,
                                v_Value1 = A.v_Value1,
                                v_Value2 = A.v_Value2,
                ...
                List<SystemParameterList> objData = queryableX.ToList();
        ...
        public List<SystemParameterList> GetSystemParametersPagedAndFilteredNewAgrupado(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, int? pintGroupId)
        {
            try
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                ...
                List<SystemParameterList> objDataN = objData.GroupBy(g => g.v_Value1).Select(s => s.First()).ToList();
        ...
        public List<SystemParameterList> GetSystemParametersPagedAndFilteredNew_OLD(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, int? pintGroupId)
        {
            try
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
        ...
        public List<SystemParameterList> GetSystemParametersPagedAndFilteredNew(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, int? pintGroupId)
        {
            ...
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = (from A in dbContext.getsystemparameterspagedandfilterednew_sp(pintGroupId)
                            select new SystemParameterList
                            {
                                i_GroupId = A.i_GroupId,
                                i_ParameterId = A.i_ParameterId,
        ...
        public SystemParameterList GetParentNameSystemParameter(ref OperationResult pobjOperationResult,int pintParameterId, int pintGroupId)
        {
            ...
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = (from A in dbContext.getparentnamesystemparameter_sp(pintParameterId, pintGroupId)
                             select new SystemParameterList
                             {
                                 v_Value1 = A.v_Value1,
                             }).FirstOrDefault();
        ...
        public SystemParameterList GetParentNameSystemParameter(ref OperationResult pobjOperationResult, int pintParameterId)
        {
            ...
            {
                SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
                var query = (from A in dbContext.getparentnamesystemparameter2_sp(pintParameterId)
                             select new SystemParameterList
                             {
                                 v_Value1 = A.v_Value1,
                             }).FirstOrDefault();
