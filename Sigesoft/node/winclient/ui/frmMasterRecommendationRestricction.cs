...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmMasterRecommendationRestricction : Form
    {
        ...
        List<MasterRecommendationRestricctionList> GetDataList = new List<MasterRecommendationRestricctionList>();
        List<MasterRecommendationRestricctionList> GetDataListTemp = new List<MasterRecommendationRestricctionList>();
        ...
        private void txtName_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                GetDataListTemp = new List<MasterRecommendationRestricctionList>(GetDataList.Where(p => p.v_Name.Contains(txtName.Text.ToUpper())));
