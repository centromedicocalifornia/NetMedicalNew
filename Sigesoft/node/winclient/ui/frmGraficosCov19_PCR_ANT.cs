...
{
    public partial class frmGraficosCov19_PCR_ANT : Form
    {
        DateTime inicio_;
        DateTime fin_;
        ...
        public frmGraficosCov19_PCR_ANT(DateTime inicio, DateTime fin, List<ServiceCovid19> _DataSource_1)
        {
            inicio_ = inicio;
            fin_ = fin;
        ...
        private void frmGraficosCov19_PCR_ANT_Load(object sender, EventArgs e)
        {
            ...
            foreach (var item in DataSource_1)
            {
                if (item.EDAD >= 0 && item.EDAD <= 11)//niño
                {
                    ...
                    else if (item.RESULTADO == "POSITIVO")
                    {
                        niño_positivo++;
                    }
            ...
            foreach (var item in DataSource_2_)
            {
                ...
                {
                    Tipo.Add(item.RESULTADO);
                    int cont = DataSource_1.Count(p => p.RESULTADO == "POSITIVO");
                    Cantidad.Add(cont);
                }
