...
{
    public partial class FrmVentasFarmacia : Form
    {
        public FrmVentasFarmacia()
        {
            InitializeComponent();
        }
        ...
        private void BindGrid()
        {
            ...
            var lista = o.BusquedaFarmacia(pdatBeginDate.Value, pdatEndDate.Value);
        ...
        private void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            NombreArchivo = "Ventas Farmacia " + dtpDateTimeStar.Text + " al " + dptDateTimeEnd.Text;
