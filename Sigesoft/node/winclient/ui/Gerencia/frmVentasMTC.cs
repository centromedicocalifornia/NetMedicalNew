...
{
    public partial class frmVentasMTC : Form
    {
        public frmVentasMTC()
        {
            InitializeComponent();
        ...
        private void BindGrid()
        {
            ...
            var lista = o.BusquedaMTC(pdatBeginDate.Value, pdatEndDate.Value);
        ...
        private void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            NombreArchivo = "Ventas MTC " + dtpDateTimeStar.Text + " al " + dptDateTimeEnd.Text;
