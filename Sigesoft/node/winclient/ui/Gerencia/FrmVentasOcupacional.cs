...
{
    public partial class FrmVentasOcupacional : Form
    {
        public FrmVentasOcupacional()
        {
            InitializeComponent();
        }
        ...
        private void BindGrid()
        {
            ...
            var lista = o.BusquedaOcupacional(pdatBeginDate.Value, pdatEndDate.Value);
        ...
        private void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            NombreArchivo = "Ventas Ocupacional " + dtpDateTimeStar.Text + " al " + dptDateTimeEnd.Text;
