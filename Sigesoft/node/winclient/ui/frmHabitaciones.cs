    ...
    public partial class frmHabitaciones : Form
    {
        ...
        private void btnGuardarTicket_Click(object sender, EventArgs e)
        {
            ...
            if (_mode == "NewASEGU" || _mode == "NewHOSPI")
            {
                ...
                if (_mode == "NewASEGU")
                {
                    ...
                    _hospitalizacionHabitaciónDto.i_ConCargoA = 0;
        ...
        private void grdDataHabitaciones_AfterSelectChange(object sender, Infragistics.Win.UltraWinGrid.AfterSelectChangeEventArgs e)
        {
            ...
            else
            {
                ...
                var objHospiS = new HospitalizacionBL().GetHospServ(_hospitalizacion);
                if (_mode != "View")
                {
                    var objDescuentoProtocolo = new ProtocolBL().GetDescuentosProtocolo(objHospiS.v_ServiceId);

                    if (objDescuentoProtocolo != null && objDescuentoProtocolo.d_CamaHosp != null && objDescuentoProtocolo.d_CamaHosp != 0)
                    {
                        txtPrecio.Text = objDescuentoProtocolo.d_CamaHosp == null || objDescuentoProtocolo.d_CamaHosp == 0 ? "0.00" : objDescuentoProtocolo.d_CamaHosp.ToString("N2");
                    }
                    else
                    {
