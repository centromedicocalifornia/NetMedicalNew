...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmLiquidacion : Form
    {
            ...
            try
            {
                using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                {
                    ...
                    foreach (var lista1 in lista)
                    {
                        ...
                        hoja.Cells[fila + i, 2] = "TOTAL EXAMEN: " + lista1.Esotype + " S/. = ";
                    ...
                    hoja.Cells[fila + i, 2] = "SUB TOTAL S/.= ";
                    ...
                    i++;
                    hoja.Cells[fila + i, 2] = "TOTAL LIQUIDACIÓN S/.= ";
        ...
        private void btnAct_Fact_Click(object sender, EventArgs e)
        {
            frmAct_Fact frm = new frmAct_Fact();
            frm.ShowDialog();
        }
