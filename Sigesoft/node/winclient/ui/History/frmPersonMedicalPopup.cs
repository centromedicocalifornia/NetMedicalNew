...
namespace Sigesoft.Node.WinClient.UI.History
{
    public partial class frmPersonMedicalPopup : Form
    {
        ...
        public frmPersonMedicalPopup(string DiagnosticName, int TypeDiagnosticId, DateTime StartDate, string DiagnosticDetail, DateTime? Date, string TreatmentSite, string Hospital, string Complicaciones, string tratamiento, string comentarios)
        {
            InitializeComponent();
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            if (uvPersonMedicalPopup.Validate(true, false).IsValid)
            {
                ...
                _Tratamiento = txtTratamiento.Text;
                _Comentarios = txtComentarios.Text;
