    ...
    public partial class frmHistory : Form
    {
        ...
        public frmHistory(string pstrPacientId)
        {
            ...
            try
            {
                ...
                if (objPersonDto.b_FingerPrintImage == null && objPersonDto.b_RubricImage == null)
                {
                    lblValidationStatus.Text = "NO REGISTRADO";
                    lblValidationStatus.ForeColor = Color.Red;
                }
                else
                {
                    lblValidationStatus.Text = "REGISTRADO";
        ...
        {
            History.frmPersonMedicalPopup frm = new History.frmPersonMedicalPopup(_DiagnosticName, _TypeDiagnosticId, _StartDate, _DiagnosticDetail, _Date, _TreatmentSite, _Hospital, _Complicaciones, _Tratamiento, _Comentarios);
            frm.ShowDialog();
            ...
            if (frm.DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                ...
                _objPersonMedicalHistoryamc.v_Tratamiento = frm._Tratamiento;
                _objPersonMedicalHistoryamc.v_Comentarios = frm._Comentarios;
        ...
        private void grdDataPersonMedical_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (row != null)
                {
                    ...
                    _Tratamiento = grdDataPersonMedical.Rows[row.Index].Cells["v_Tratamiento"].Value.ToString();
                    _Comentarios = grdDataPersonMedical.Rows[row.Index].Cells["v_Comentarios"].Value.ToString();
        ...
        private void btnSavePersonMedical_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in _TempPersonMedicalHistoryList)
            {
                ...
                if (item.i_RecordType == (int)RecordType.Temporal && item.i_RecordStatus == (int)RecordStatus.Agregado)
                {
                    ...
                    personmedicalhistoryDtoDto.v_Tratamiento = item.v_Tratamiento;
                    personmedicalhistoryDtoDto.v_Comentarios = item.v_Comentarios;
            ...
            foreach (var item in _objSystemParameterList)
            {
                if (item.i_Answer == (int)SiNo.NONE)
                {
                    ...
                    personmedicalhistoryDtoDto.v_Tratamiento = String.Empty;
                    personmedicalhistoryDtoDto.v_Comentarios = String.Empty;
                    personmedicalhistoryDtoDto.i_AnswerId = item.i_Answer;
        ...
        private void btnOtros_Click(object sender, EventArgs e)
        {
            ...
            if (findResult == null)
            {
                ...
                objPersonMedicalHistory.v_Tratamiento = frmPersonMedicalPopup._Tratamiento;
                objPersonMedicalHistory.v_Comentarios = frmPersonMedicalPopup._Comentarios;
            ...
            else
            {
                if (findResult.i_RecordStatus == (int)RecordStatus.EliminadoLogico)
                {
                    if (findResult.i_RecordType == (int)RecordType.NoTemporal)// El registro Tiene in ID de BD
                    {
                        ...
                        findResult.v_Tratamiento = frmPersonMedicalPopup._Tratamiento;
                        findResult.v_Comentarios = frmPersonMedicalPopup._Comentarios;
        ...
        private void LoadTreeNoxiuosHabits(int pintItemId)
        {
            ...
            //objSystemParameterList = objSystemParameterBL.GetSystemParametersPagedAndFiltered(ref objOperationResult, 0, null, "", pintItemId, 148);
        ...
        private void btnOtrosFamilyMedical_Click(object sender, EventArgs e)
        {
            ...
            {
                if (item.v_TypeFamilyName == frmFamilyMedicAntecedentPopup._Group && item.v_DiseasesId == objDiseasesList.v_DiseasesId)
                {
                    validador = 1;
                }
                else
        ...
        private void ultraGrid2_CellChange(object sender, CellEventArgs e)
        {
            ...
            if (e.Cell.Column.Key == "SI")
            {
                ...
                History.frmPersonMedicalPopup frm = new History.frmPersonMedicalPopup(Value2, -1, DateTime.Now.Date, null, DateTime.Now.Date, null,null,null, null, null);
                frm.ShowDialog();
                if (frm.DialogResult != System.Windows.Forms.DialogResult.OK)
                {
                ...
                if (findResult == null)
                {
                    ...
                    objPersonMedicalHistory.v_Tratamiento = frm._Tratamiento;
                    objPersonMedicalHistory.v_Comentarios = frm._Comentarios;
                ...
                else
                {
                    if (findResult.i_RecordStatus == (int)RecordStatus.EliminadoLogico)
                    {
                        if (findResult.i_RecordType == (int)RecordType.NoTemporal)// El registro Tiene in ID de BD
                        {
                            ...
                            findResult.v_Tratamiento = frm._Tratamiento;
                            findResult.v_Comentarios = frm._Comentarios;
        ...
        private void contextMenuPersonMedical_Opening(object sender, CancelEventArgs e)
        {
