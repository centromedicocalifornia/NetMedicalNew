    ...
    public partial class frmHabitacion : Form
    {
        ...
        private void cboHabitación_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (objDescuentoProtocolo.d_CamaHosp != null && objDescuentoProtocolo.d_CamaHosp != 0) 
                {
                    txtPrecio.Text = objDescuentoProtocolo.d_CamaHosp == null || objDescuentoProtocolo.d_CamaHosp == 0 ? "0.00" : objDescuentoProtocolo.d_CamaHosp.ToString();
                }
                else
                {
