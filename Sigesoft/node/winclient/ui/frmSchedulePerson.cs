            ...
            else
            {
                ...
                try
                {
                    ...
                    if ((validar != "" && validar != null) && validar2 != "html")
                    {
                        ...
                        txtName.Text = desconcat[6].Replace("\"", "").Trim();
                        txtFirstLastName.Text = desconcat[4].Replace("\"", "").Trim();

                        txtSecondLastName.Text = desconcat[12].Replace("\"", "").Trim();
                        txtSecondLastName.Text = txtSecondLastName.Text.Replace("}", "").Trim();
                        txtSecondLastName.Text = txtSecondLastName.Text.Replace("]", "").Trim();

                        txtDocNumber.Text = desconcat[2].Replace("\"", "").Trim();
                        dtpBirthdate.Value = DateTime.Parse(desconcat[8].Replace("\"", "").Trim());
                        ddlSexTypeId.SelectedValue = desconcat[10].Replace("\"", "").Trim() == "3" ? "2" : desconcat[10].Replace("\"", "").Trim() == "2" ? "1" : "1";
                        ddlDocTypeId.SelectedValue = "1";
                        //_personId = null;
                    }
                    else
                    {
                        ...
                        if (DataReniec != null && DataReniec != "null")
                        {
                            ...
                            txtName.Text = desconcat[9].Replace("\"", "").Replace("}", "").Trim();
                            txtFirstLastName.Text = desconcat[5].Replace("\"", "").Trim();
                            txtSecondLastName.Text = desconcat[7].Replace("\"", "").Trim();
