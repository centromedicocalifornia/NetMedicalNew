        ...
        private void Atender()
        {
            ...
            if (Result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                Form frm;
                        ...
                        string Paciente = grdListaLlamando.Selected.Rows[0].Cells["v_Pacient"].Value.ToString();

                        frm = new Operations.frmContainerEso(_serviceId, "TRIAJE", _modo, TserviceId, _personId, Paciente);
                        frm.ShowDialog();
                        this.Enabled = true;
