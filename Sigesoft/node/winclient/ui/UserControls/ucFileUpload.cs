    ...
    public partial class ucFileUpload : UserControl
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (dgvFiles.SelectedRows.Count > 0)
            {
                ...
                if (rp == DialogResult.OK)
                {
                    ...
                    else if (Consultorio == "PSICOSENSOMETRICO")
                    {
                        rutaOrigen = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgPsicosensometricoOrigen").ToString());
                    }
                    if (rutaOrigen == null)
                    {
        ...
        private void btnDescargar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    foreach (FileInfo file in files)
                    {
                        ...
                        if (file.ToString().Count() > 16)
                        {
                            if (file.ToString().Substring(0, 17) == Dni + "-" + Fecha1)
                            {
                                ...
                                file.CopyTo(Path.Combine(rutaDestino + "-" + Contador + ext),true);
                                Contador++;
                            };
                        }
                    }
                ...
                {
                    rutaOrigen = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgPsicosensometricoOrigen").ToString());
                    ruta = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgPsicosensometricoDestino").ToString());
                    rutaDestino = Common.Utils.GetApplicationConfigValue("ImgPsicosensometricoDestino").ToString() + Dni + "-" + Fecha1;
                ...
                MessageBox.Show("Los archivos se copiaron correctamente en la siguiente ruta: " + Common.Utils.GetApplicationConfigValue("ImgPsicosensometricoDestino").ToString());
