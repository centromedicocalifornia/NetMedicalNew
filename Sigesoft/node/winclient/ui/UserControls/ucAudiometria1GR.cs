...
{
    public partial class ucAudiometria1GR : UserControl
    {
        ...
        private void ShowGraphicOI()
        {
            ...
            foreach (var row in AudioOIList)
            {
                ...
                //{
                //    chart1.Series[seriesName].MarkerImage = Application.StartupPath + @"\Resources\cruz.png";
                //    chart1.Series[seriesName].Color = Color.Blue;
                //}
                //else if (seriesName == "Via Osea OI")
                //{
                //    chart1.Series[seriesName].MarkerImage = Application.StartupPath + @"\Resources\mayorazul.png";
                ...
                for (int colIndex = 1; colIndex < propertyInfo.Length; colIndex++)
                {
                    ...
                    //    chart1.Series[seriesName].Points[colIndex - 1].Color = Color.Blue;
                    //}
                    else
                    {
                        if (seriesName == "Via Aerea OI")
                        {
                            chart1.Series[seriesName].Points[colIndex - 1].MarkerImage = Application.StartupPath + @"\Resources\cruz.png";                            
                            chart1.Series[seriesName].Points[colIndex - 1].Color = Color.Blue;
                            chart1.Series[seriesName].BorderDashStyle = ChartDashStyle.Dash;
                        }
                        else if (seriesName == "Via Osea OI")
                        {
                            chart1.Series[seriesName].Points[colIndex - 1].MarkerImage = Application.StartupPath + @"\Resources\mayorazul.png";
                            chart1.Series[seriesName].Points[colIndex - 1].Color = Color.Transparent;
                        }
                        else if (seriesName == "Enmascaramiento OI")
                        {
                            chart1.Series[seriesName].Points[colIndex - 1].MarkerImage = Application.StartupPath + @"\Resources\CorcheteAzul.png";
                            chart1.Series[seriesName].Points[colIndex - 1].Color = Color.Transparent;
                        }
                        else if (seriesName == "Anacusia OI")
                        {
                            chart1.Series[seriesName].Points[colIndex - 1].MarkerImage = Application.StartupPath + @"\Resources\cuadradoazul.png";
                            chart1.Series[seriesName].Points[colIndex - 1].Color = Color.Transparent;
                        }
                    }
        ...
        {                 
            ...
            var propertyInfo2 = AudioOIList.GetType().GetGenericArguments()[0].GetProperties();
            var propertyInfo1 = AudioODList.GetType().GetGenericArguments()[0].GetProperties();
            var propertyInfoLine25 = LineList25.GetType().GetGenericArguments()[0].GetProperties();
            var propertyInfoLine50 = LineList50.GetType().GetGenericArguments()[0].GetProperties();
            ...
            foreach (var row in AudioOIList)
            {
                ...
                for (int colIndex = 1; colIndex < propertyInfo2.Length; colIndex++)
                {
                    // for each column (column 1 and onward), add the value as a point
                    string columnName = propertyInfo2[colIndex].Name;
                    object YVal = AudioOIList.GetType().GetGenericArguments()[0].GetProperty(columnName).GetValue(row, null);
            ...
            foreach (var row in AudioODList)
            {
                ...
                for (int colIndex = 1; colIndex < propertyInfo1.Length; colIndex++)
                {
                    // for each column (column 1 and onward), add the value as a point
                    string columnName = propertyInfo1[colIndex].Name;
        ...
        private void SaveImagenAudiograma()
        {
            ...
            chart1.SaveImage(chartAudiogramaOI, ChartImageFormat.Png);
        ...
        private void ucAudiometria1GR_Load(object sender, EventArgs e)
        {
            LoadDxAndRecoAndRes();
            ShowGraphicOD();
            //ShowGraphicOI();
