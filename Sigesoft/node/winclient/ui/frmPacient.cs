...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmPacient : Form
    {
        ...
        string[] nombreCampos =
        {
            ...
            "txtContactoEmergencia", "txtTelefEmergencia"
        };
        ...
        private void frmAdministracion_Load(object sender, EventArgs e)
        {
            ...
            var lista = _PacientBL.LlenarPerson(ref objOperationResult); //NEW STORE
            ...
            if (_personId != null)
            {
                ...
                label20.Text = string.Format("Se encontraron {0} registros.", Lista.Count());
            }
        }
        ...
        private void BindGrid()
        {
            ...
            else
            {
                ...
                //}
                label20.Text = string.Format("Se encontraron {0} registros.", objData.Count());
                if (grdData.Rows.Count > 0)
                {
                    grdData.Rows[0].Selected = true;
                }
        ...
        private void loadData(string strPacientId, string pstrMode)
        {
            ...
            else if (Mode == "Edit")
            {
                ...
                txtContactoEmergencia.Text = objpacientDto.v_ContactName;
                txtTelefEmergencia.Text = objpacientDto.v_TelephoneNumber;
        ...
        private void ActivarControles(Boolean valor)
        {
            ...
            txtTelefEmergencia.ReadOnly = !valor;
            txtContactoEmergencia.ReadOnly = !valor;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (uvPacient.Validate(true, false).IsValid)
            {
                ...
                if (Mode == "New")
                {
                    ...
                    objpersonDto.v_ResidenciaAnterior = txtResideAnte.Text;
                    objpersonDto.v_Religion = txtReligion.Text;
                    objpersonDto.v_ContactName = txtContactoEmergencia.Text.Trim();
                    objpersonDto.v_EmergencyPhone = txtTelefEmergencia.Text.Trim();
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            NombreArchivo = "Reporte de PACIENTES";
