...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmService : Form
    {
        ...
        {
            InitializeComponent();
            //grdDataService.DataSource = new BindingList<ServiceGridJerarquizadaList>();btnGeneracionMasivaReportes
        ...
        private void frmService_Load(object sender, EventArgs e)
        {
            ...
            //
            if (usuarioActual == 11 || usuarioActual == 175 || usuarioActual == 169 || usuarioActual == 168 || usuarioActual == 193)
            {
                checkReducirBusquedaAp.Checked = false;
            }
            else
            {
                checkReducirBusquedaAp.Checked = true;
            }

            if (usuario_professional.v_ComentaryUpdate == "BLOQUEADO")
            {
                ...
                //ddlEstadoConsultorio.SelectedIndexChanged -=  ddlse
                ...
                Utils.LoadDropDownList(cboHistoriaGenerada, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo(ref objOperationResult, 111, null), DropDownListAction.All);
                ...
                Utils.LoadDropDownList(ddlEstadoConsultorio, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo_Consultorio(ref objOperationResult, 127, null, -1), DropDownListAction.All);
            ...
            if (Globals.ClientSession.i_SystemUserId == 181)      //luis sanchez
            {
                ddlServiceTypeId.SelectedValue = "1";
                ddlServiceTypeId.Enabled = false;
                ddlConsultorio.SelectedValue = "1";
                ddlConsultorio.Enabled = false;
                ddlEstadoConsultorio.SelectedValue = "6";
                ddlEstadoConsultorio.Enabled = false;
            }
                  
            //if (Globals.ClientSession.i_SystemUserId == 177)     //scarlet
            //{
            //    ddlServiceTypeId.SelectedValue = "1";
            //    //ddlServiceTypeId.Enabled = false;
        ...
        private void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            //if (ddlMasterServiceId.SelectedValue != null && ddlMasterServiceId.SelectedValue.ToString() != "-1") Filters.Add("i_MasterServiceId==" + ddlMasterServiceId.SelectedValue);
            //if (ddlServiceTypeId.SelectedValue != null && ddlServiceTypeId.SelectedValue.ToString() != "-1") Filters.Add("i_ServiceTypeId==" + ddlServiceTypeId.SelectedValue);
            //if (ddlEsoType.SelectedValue != null && ddlEsoType.SelectedValue.ToString() != "-1") Filters.Add("i_EsoTypeId==" + ddlEsoType.SelectedValue);
            //if (ddlProtocolId.SelectedValue != null && ddlProtocolId.SelectedValue.ToString() != "-1") Filters.Add("v_ProtocolId==" + "\"" + ddlProtocolId.SelectedValue + "\"");
            //if (ddlStatusAptitudId.SelectedValue != null && ddlStatusAptitudId.SelectedValue.ToString() != "-1") Filters.Add("i_AptitudeStatusId==" + ddlStatusAptitudId.SelectedValue);
        ...
        private void BindGrid()
        {
            ...
            else if (int.Parse(ddlServiceTypeId.SelectedValue.ToString()) == 1)
            {
                grdDataService.DisplayLayout.Bands[0].Columns["d_BirthDate"].Hidden = true;
                grdDataService.DisplayLayout.Bands[0].Columns["Facturacion"].Hidden = true;
                grdDataService.DisplayLayout.Bands[0].Columns["v_TelephoneNumber"].Hidden = true;
        ...
        private BindingList<ServiceGridJerarquizadaList> GetData(int pintPageIndex, int? pintPageSize, string pstrSortExpression, string pstrFilterExpression)
        {
            ...
            if (!chkFC.Checked)
            {
                FCI = pdatBeginDate;//DateTime.Parse("01/01/2000");
                FCF = pdatEndDate; //DateTime.Parse("01/01/2050");
            }
            var usuarioActual = Globals.ClientSession.i_SystemUserId;
            ...
            if (objOperationResult.Success != 1)
            {
             ...
             #region Filters
            if (checkReducirBusquedaAp.Checked == true)
            {
                List<ServiceGridJerarquizadaList> Data = _objData.Where(p => p.i_AptitudeStatusId  == 1).ToList();
            ...
            if (!String.IsNullOrEmpty(txtPacient.Text))
            {
                ...
                //List<ServiceGridJerarquizadaList> Data = new List<ServiceGridJerarquizadaList>(_objData.Where(p => p.v_Pacient.Contains(txtPacient.Text.ToUpper()) || p.v_DocNumber.Contains(txtPacient.Text)));
            }
            ...
            if (ddlStatusAptitudId.SelectedIndex != 0)
            {
                List<ServiceGridJerarquizadaList> Data = _objData.Where(p => p.i_AptitudeStatusId == Convert.ToInt32(ddlStatusAptitudId.SelectedValue)).ToList();
                _objData = new BindingList<ServiceGridJerarquizadaList>(Data);
            }

            if (cboHistoriaGenerada.SelectedValue != "-1")
            {
                int val = 0;
                if (Convert.ToInt32(cboHistoriaGenerada.SelectedValue) == 0)
                {
                    val = 1;
                }
                else if (Convert.ToInt32(cboHistoriaGenerada.SelectedValue) == 1)
	            {
                    val = 2;
	            }
                List<ServiceGridJerarquizadaList> Data = _objData.Where(p => p.i_StatusLiquidation == val).ToList();
                _objData = new BindingList<ServiceGridJerarquizadaList>(Data);
            }
            ...
            if (ddlConsultorio.SelectedIndex != 0)
            {
                ...
                if (ddlEstadoConsultorio.SelectedValue != "-1")
                {
                    foreach (var item in _objData)
                    {
                        bool result = ObtenerEstadoConsultorio(item.v_ServiceId, ddlConsultorio.Text, ddlEstadoConsultorio.Text);
                        if (result)
                        {
                            Data.Add(item);
                        }
        ...
        private void btnEditarESO_Click(object sender, EventArgs e)
        {
            ...
            int user = Globals.ClientSession.i_SystemUserId;
            if (aptitud != "SIN APTITUD" && user != 11 && user != 175 && user != 168 && user != 169 && user != 173 && user != 172 && user != 171 && user != 191) { _modo = "View"; }
            else { _modo = "Service"; }
            try
            {
                Form frm;
                ...
                if (TserviceId == (int) MasterService.AtxMedicaParticular ||
                    TserviceId == (int) MasterService.AtxMedicaSeguros)
                {
                    frm = new Operations.frmConsultorios(_serviceId, "MEDICINA C", _modo, Globals.ClientSession.i_RoleId.Value, Globals.ClientSession.i_CurrentExecutionNodeId, Globals.ClientSession.i_SystemUserId, 1);
                    frm.ShowDialog();
                ...
                else
                {
                    ...
                    frm = new Operations.frmContainerEso(_serviceId, "", _modo, TserviceId, _pacientId, Paciente);
                    frm.ShowDialog();
                }
                //var t = new Thread(() =>{
                ...
                if (banda == "0")
                {
                    if (row.Band.Index.ToString() == "0")
                    {
                        ...
                        else if (e.Row.Cells["i_ServiceStatusId"].Value.ToString() == ((int)ServiceStatus.Culminado).ToString())
                        {
                            ...
                            {
                                //e.Row.Appearance.BackColor = Color.FromArgb(8, 0, 252);
                                e.Row.Appearance.BackColor = Color.Red;
                                e.Row.Appearance.BackColor2 = Color.White;
                                //Y doy el efecto degradado vertical
                                e.Row.Appearance.BackGradientStyle = Infragistics.Win.GradientStyle.VerticalBump;
                            }
                            else if (e.Row.Cells["v_AptitudeStatusName"].Value.ToString() == "POR REEVALUAR")
                            {
                                //e.Row.Appearance.BackColor = Color.FromArgb(8, 0, 252);
                            ...
                            else if (e.Row.Cells["v_AptitudeStatusName"].Value.ToString() == "NO REALIZADO")
                            {
                                //e.Row.Appearance.BackColor = Color.FromArgb(8, 0, 252);
                            ...
                            else if (e.Row.Cells["v_AptitudeStatusName"].Value.ToString() == "NO APTO")
                            {
                            ...
                            //else if (e.Row.Cells["TipoServicio"].Value.ToString().Split(' ')[0] == "LABORATORIO")
                            //{
                            //    //e.Row.Appearance.BackColor = Color.FromArgb(8, 0, 252);
        ...
        private void grdDataService_ClickCell(object sender, ClickCellEventArgs e)
        {
            ...
            //}
            string aptitud = VerificarAptitud(_serviceId);
            if (aptitud != "SIN APTITUD") { _modo = "View"; }
            else { _modo = "Service"; }
        }
        ...
        private void btnGenerarIds_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            frmReportingServer frm = new frmReportingServer();
            frm.ShowDialog();
        }
            ...
            using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
            {
                ...
                foreach (var item_0 in ListaServicios)
                {
                     ...
                     var empresaClienteId = item_0.EmpresaCliente;
                       ...
                       var serviceComponenteEstado = _serviceBL.ValoresComponente_ManagerReport(item_0.ServiceId);
                       ...
                       _LogicReports.CrearReportesCrystal(item_0.ServiceId, item_0.PacienteId, _ComponentsIdsOrdenados, _customerOrganizationName, "", "", false);
        ...
        {
            string personId = grdDataService.Selected.Rows[0].Cells["v_PersonId"].Value.ToString();
            if (personId != null)
            {
                using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                {
        ...
        private void btnEditarESO_Click(object sender, DoubleClickRowEventArgs e)
        {
            ...
            if (TserviceId == (int)MasterService.AtxMedicaParticular)
            {
                ...
                frm = new Operations.FrmEsoV2(_serviceId, "TRIAJE", _modo, Globals.ClientSession.i_RoleId.Value, Globals.ClientSession.i_CurrentExecutionNodeId, Globals.ClientSession.i_SystemUserId, TserviceId);
                frm.ShowDialog();
                #endregion
            ...
            else
            {
                ...
                if (EstadoServicio == (int)ServiceStatus.Culminado)
                {
                    ...
                    {
                        this.Enabled = false;
                        frm = new Operations.frmEso(_serviceId, null, _modo, TserviceId);
                        frm.ShowDialog();
                        this.Enabled = true;
                    }
                    else
                ...
                {
                    this.Enabled = false;
                    frm = new Operations.frmEso(_serviceId, null, _modo, (int)MasterService.Eso);
                    frm.ShowDialog();
                    this.Enabled = true;
                }
        ...
        private void GenerarHistoria()
        {
            ...
            //int eso = 1;
            //if (flagPantalla == 2 || flagPantalla == 35 || flagPantalla == 36 || flagPantalla == 37)
            //{
                ...
                var frm = new Reports.frmManagementReports_Async(_serviceId, _EmpresaClienteId, _pacientId,
                    _customerOrganizationName, dni, pacientName, aptitud);
                frm.ShowDialog();
            //}
            //else
            //{
        ...
        private static void InitializeRowDetail_1(UltraGridRow row, DiagnosticRepositoryJerarquizada item)
        {
            row.Cells["v_DiseasesName"].Value = item.v_DiseasesName;
            row.Cells["v_RecomendationsName"].Value = item.v_RecomendationsName;
            row.Cells["v_RestricctionName"].Value = item.v_RestricctionName;
        ...
        private void grdDataService_DoubleClickCell(object sender, DoubleClickCellEventArgs e)
        {
            ...
            try
            {
                ...
                //    frm = new Operations.FrmEsoV2(_serviceId, "", _modo, Globals.ClientSession.i_RoleId.Value, Globals.ClientSession.i_CurrentExecutionNodeId, Globals.ClientSession.i_SystemUserId, TserviceId);
                //    frm.ShowDialog();
                //    #endregion
                //}
                //else
                //{
                    ...
                    if (estadoAptitud != (int)AptitudeStatus.SinAptitud || estadoAptitud == (int)AptitudeStatus.AptoObs)
                    {
                        //Obtener el usuario
                        int UserId = Globals.ClientSession.i_SystemUserId;
                        if (UserId == 11 || UserId == 175 || UserId == 173 || UserId == 172 || UserId == 171 || UserId == 168 || UserId == 169 && user == 173 && user == 172 && user == 171 && user == 191)
                        {
                            this.Enabled = false;
                            var t = new Thread(() =>
                            {
                    ...
                    else
                    {
                        ...
                        frm = new Operations.frmContainerEso(_serviceId, null, _modo, TserviceId, _pacientId, Paciente);
                        //frm = new Operations.FrmEsoV2(_serviceId, null, _modo, Globals.ClientSession.i_RoleId.Value, Globals.ClientSession.i_CurrentExecutionNodeId, Globals.ClientSession.i_SystemUserId, TserviceId);
                        frm.ShowDialog();
                        this.Enabled = true;
                    }
                        ...
                        foreach (var row in grdDataService.Selected.Rows)
                        {
                            ...
                            if (ServiceStatusId == (int)ServiceStatus.Culminado)
                            {
                                using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                                {
                                    ...
                                    var serviceComponenteEstado = _serviceBL.ValoresComponente_ManagerReport(ServiceId);
                                    foreach (var item in ordenReportes)
                                    {
                                        var obj = new ServiceComponentList();
                                        var exist = list.Find(p => p.v_ComponentId == item.v_ComponentId);
        ...
        private void grdDataService_MouseDown_1(object sender, MouseEventArgs e)
        {
            if (grdDataService.Selected.Rows.Count == 0)
            {
                ...
                cmGridService.Items["rayosXToolStripMenuItem"].Visible = false;
            }
            else
            {
                ...
                if (grdDataService.Selected.Rows[0].Cells != null)
                {
                    servicio = grdDataService.Selected.Rows[0].Cells["TipoServicio"].Value.ToString();
                }
                else
                {
                    if (grdDataService.Selected.Rows[0].Cells == null)
                    ...
                    {
                        servicio = grdDataService.Selected.Rows[1].Cells["TipoServicio"].Value.ToString();
                ...
                {
                    if (servicio == "EMO - PRE-OCUPACIONAL" || servicio == "EMO - PERIÓDICO O ANUAL" || servicio == "EMO - DE RETIRO")
                    {
                        cmGridService.Items["rayosXToolStripMenuItem"].Visible = true;
                    }
                    else
                    {
                        cmGridService.Items["rayosXToolStripMenuItem"].Visible = false;
        ...
        private void ddlConsultorio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ddlEstadoConsultorio.Enabled = true;
            }
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        this.Enabled = false;
                        _pacientId = grdDataService.Selected.Rows[0].Cells["v_PersonId"].Value.ToString();
                        //frm = new Operations.frmContainerEso(_serviceId, null, _modo, (int)MasterService.Eso, _pacientId);
                        frm = new Operations.frmEso(_serviceId, null, _modo, (int)MasterService.Eso);
                        frm.ShowDialog();
                        this.Enabled = true;
                    }
        ...
        {
            frmPaymentMedic frm = new frmPaymentMedic();
            frm.ShowDialog();
        }

        private void button4_Click_1(object sender, EventArgs e)
        {
            frmPaymentMedical frm = new frmPaymentMedical();
            frm.ShowDialog();
            //frmPruebaFacial frm = new frmPruebaFacial();
            //frm.ShowDialog();
        }
        ...
        private void btnCreateFiles_Click(object sender, EventArgs e)
        {
            ...
            files.Add(Common.Utils.GetApplicationConfigValue("ImagenesTemporales").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaCotizacion").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaReportes").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaConsolidado").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaHistoriaClinica").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaLiquidacion").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaPagoMedicos").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgRxOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgRxDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgEKGOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgEKGDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgESPIROOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgESPIDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgLABOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgLABDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgOftalmoOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgOftalmoDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgMedicinaOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgMedicinaDestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgPSICOOrigen").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("ImgPSICODestino").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaReportesBasura").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("Certificado312").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("CertificadoEmp").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("CertificadoObs").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("CertificadoRetiro").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("CertificadoSinDX").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("Interconsulta").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("Asistencia").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("InformeTrab1").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("InformeTrab3").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("LiquidacionAseguradora").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("LiquidacionHospitalizacion").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaExamenesAdicionales").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaTicketsH").ToString());
            files.Add(Common.Utils.GetApplicationConfigValue("rutaTramas").ToString());
            ...
            foreach (var f in files)
            {
                try
                {
                    ...
                    else{DirectoryInfo di = Directory.CreateDirectory(f);}
            ...
            MessageBox.Show("Carpetas generadas...", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void button5_Click_1(object sender, EventArgs e)
        {
            frmCovid15 frm = new frmCovid15();
            frm.ShowDialog();
        }
        ...
        private void rayosXToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            string personId = grdDataService.Selected.Rows[0].Cells["v_PersonId"].Value.ToString();
            string nombrePerson = grdDataService.Selected.Rows[0].Cells["v_Pacient"].Value.ToString();
            string servicioId = grdDataService.Selected.Rows[0].Cells["v_ServiceId"].Value.ToString();
            string dni = grdDataService.Selected.Rows[0].Cells["v_DocNumber"].Value.ToString();
             
            if (personId != null && servicioId != null)
            {
                //using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
                //{
                var frm = new frmDescargarAdjuntosConsultorios("RX", servicioId, personId, nombrePerson, dni);
                    frm.ShowDialog();
                //}
            }
            else
        ...
        {
            //frmVisorPdf frm = new frmVisorPdf();
            //frm.ShowDialog();
            ...
            if (personId != null)
            {
                ...
                {
                    string Paciente = grdDataService.Selected.Rows[0].Cells["v_Pacient"].Value.ToString();
                    var frm = new frmVisorPdf(personId, Paciente);
                    frm.ShowDialog();
                }
            }
            else
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
            {
                var frm = new frmCopiarDigitales(ListaGrilla);
                frm.ShowDialog();
            }
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            string numero = grdDataService.Selected.Rows[0].Cells["v_TelephoneNumber"].Value.ToString();
            string urlCompleta = "";
        ...
        private void txtPacient_KeyUp(object sender, KeyEventArgs e)
        {
            if (txtPacient.Text != string.Empty)
            {
                ...
                List<ServiceGridJerarquizadaList> listnew = new List<ServiceGridJerarquizadaList>();

                listnew = new List<ServiceGridJerarquizadaList>(list.Where(p => p.v_Pacient.Contains(txtPacient.Text.ToUpper()) || p.v_DocNumber.Contains(txtPacient.Text.ToUpper())));

                var listBinding = new BindingList<ServiceGridJerarquizadaList>(listnew);

                grdDataService.DataSource = listBinding;
            ...
            {
                grdDataService.DataSource = ListaGrilla;
                if (grdDataService != null)
                {
                    lblRecordCountCalendar.Text = string.Format("Se encontraron {0} registros.", ListaGrilla.Count());

                }
            }
        }

        private void checkDataTodos_CheckedChanged(object sender, EventArgs e)
        {
            if (checkDataTodos.Checked == true)
            {
                grdDataService.DisplayLayout.Bands[0].Columns["d_BirthDate"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Facturacion"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["v_TelephoneNumber"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Rx_DCM"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Rx_JPG"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Rx_PDF"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Esp"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["Ekg"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["v_ComprobantePago"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["v_ProtocolName"].Hidden = false;
                grdDataService.DisplayLayout.Bands[0].Columns["TipoServicio"].Hidden = false;
                ...
                grdDataService.DisplayLayout.Bands[0].Columns["UsuarioCrea"].Header.VisiblePosition = 13;
                grdDataService.DisplayLayout.Bands[0].Columns["v_MedicoTratante"].Header.VisiblePosition = 14;
                grdDataService.DisplayLayout.Bands[0].Columns["d_BirthDate"].Header.VisiblePosition = 15;
                grdDataService.DisplayLayout.Bands[0].Columns["v_TelephoneNumber"].Header.VisiblePosition = 21;
