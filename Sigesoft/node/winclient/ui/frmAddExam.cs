    ...
    public partial class frmAddExam : Form
    {
        ...
        private void AddAuxiliaryExam()
        {
            ...
            if (res != null)
            {
                ...
                if (DialogResult == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    var serviceId = calendarBl.AddShedule(ref objOperationResult, objCalendarDto, Globals.ClientSession.GetAsList(), protocolId, objCalendarDto.v_PersonId, (int)MasterService.Hospitalizacion, "Nuevo");
                    ...
                    objServiceDto.v_OrganizationId = "N009-OO000000670";
                    ...
                    foreach (var servicesComponent in servicesComponents)
                    {
                        ...
                        oservicecomponentDto.d_SaldoAseguradora = 0;
                        oservicecomponentDto.d_SaldoPaciente = 0;
                        oservicecomponentDto.i_ConCargoA = 0;
                        oservicecomponentDto.i_PayMedic = 1;
                        oservicecomponentDto.i_ApplicantMedic = 11;
        ...
        private void frmAddAdditionalExam_Load(object sender, EventArgs e)
        {
            ...
            if (_modo == "HOSPI" || _modo == "ASEGU")
            {
                ...
                cboMedicoSolicitante.Enabled = true;
                Utils.LoadDropDownList(cboMedicoSolicitante, "Value1", "Id", BLL.Utils.GetProfessionalName(ref objOperationResult), DropDownListAction.Select);
                cboMedicoSolicitante.SelectedValue = "11";
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (cboMedicoSolicitante.SelectedValue.ToString() == "-1")
            {
                MessageBox.Show("Seleccionar un médico tratante", " ¡ VALIDACIÓN!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
                ...
                foreach (var scid in ComponentId)
                {
                    ...
                    if (_modo == "ASEGU")
                    {
                        ...
                        switch (i_KindOfService)
                        {
                            ...
                            objServiceComponentDto.i_ApplicantMedic = int.Parse(cboMedicoSolicitante.SelectedValue.ToString());
                            objServiceComponentDto.i_Cantidad = 1;
                            objServiceComponentDto.i_PayMedic = 0;
