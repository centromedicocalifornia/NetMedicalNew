...
namespace Sigesoft.Node.WinClient.UI.Operations
{
    public partial class frmContainerEso : Form
    {
        ...
        public frmContainerEso(string serviceId, string componentIdByDefault, string action, int tipo, string personId, string v_Pacient)
        {
            InitializeComponent();
        ...
        private void frmContainerEso_Load(object sender, EventArgs e)
        {
            ...
            if (_action == "View")
            {
                lblAptitud.Text = "El paciente ya tiene aptitud, está activado el modo : '' Vista''; si necesita editar, comuníquese con el personal indicado";
            }
            };
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (_personId != null)
            {
                ...
                {
                    var frm = new frmVisorPdf(_personId, _v_Pacient);
                    frm.ShowDialog();
                }
            }
            else
