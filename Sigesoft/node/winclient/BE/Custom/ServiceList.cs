   ...
   public class ServiceList
    {
       ...
       public string EmpresaClienteId  { get; set; }
        ...
        //public List<DiagnosticRepositoryList> Diagnosticos { get; set; } // lista innecesaria
       ...
       public int? AltaCovid19_1 { get; set; }
       public int AltaCovid19_2 { get; set; }
   }
   public class ServiciosTramas
   {
       public string v_ServiceId { get; set; }
       public string nombre { get; set; }
       public string genero { get; set; }
