...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class systemuserDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_Permiso1 { get; set; }

        [DataMember()]
        public Nullable<Int32> i_Permiso2 { get; set; }

        [DataMember()]
        public Nullable<Int32> i_Permiso3 { get; set; }

        [DataMember()]
        public Nullable<Int32> i_Permiso4 { get; set; }

        [DataMember()]
        public Nullable<Int32> i_Permiso5 { get; set; }
        ...
        public systemuserDto(Int32 i_SystemUserId, String v_PersonId, String v_UserName, String v_Password, String v_SecretQuestion, String v_SecretAnswer, Nullable<DateTime> d_ExpireDate, String v_SystemUserByOrganizationId, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_SystemUserTypeId, Nullable<Int32> i_RolVentaId, String v_ComentaryUpdate, Nullable<Int32> i_LoginFrecuency, Nullable<Int32> i_Permiso1, Nullable<Int32> i_Permiso2, Nullable<Int32> i_Permiso3, Nullable<Int32> i_Permiso4, Nullable<Int32> i_Permiso5, personDto person)
        {
			...
			this.i_Permiso1 = i_Permiso1;
			this.i_Permiso2 = i_Permiso2;
			this.i_Permiso3 = i_Permiso3;
			this.i_Permiso4 = i_Permiso4;
			this.i_Permiso5 = i_Permiso5;
			this.person = person;
        }
    }
}
